...
BoolPropertyRNA rna_Sculpt_use_deform_only = {
	{(PropertyRNA *)&rna_Sculpt_show_mask, (PropertyRNA *)&rna_Sculpt_use_threaded,
...
static const EnumPropertyItem rna_GpPaint_color_mode_items[3] = {
	...
	{1, "VERTEXCOLOR", 0, "Vertex Color", "Paint the material with custom vertex color"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_GpPaint_color_mode = {
	{NULL, NULL,
	-1, "color_mode", 1, 0, 0, 0, 0, "Mode",
	"Paint Mode",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GpPaint_color_mode_get, GpPaint_color_mode_set, NULL, NULL, NULL, NULL, rna_GpPaint_color_mode_items, 2, 0
};
...
StructRNA RNA_VertexPaint = {
	{(ContainerRNA *)&RNA_ImagePaint, (ContainerRNA *)&RNA_GpWeightPaint,
	NULL,
...
FloatPropertyRNA rna_ParticleEdit_emitter_distance = {
	...
	ParticleEdit_emitter_distance_get, ParticleEdit_emitter_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.2500000000f, NULL
};
...
FloatPropertyRNA rna_ParticleBrush_strength = {
	...
	ParticleBrush_strength_get, ParticleBrush_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 1.0f, 0.0010000000f, 1.0f, 10.0f, 3, 0.5000000000f, NULL
};
...
EnumPropertyRNA rna_GPencilSculptGuide_type = {
	...
	NULL, 68091904, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GPencilSculptGuide_type_get, GPencilSculptGuide_type_set, NULL, NULL, NULL, NULL, rna_GPencilSculptGuide_type_items, 5, 0
};
...
FloatPropertyRNA rna_GPencilSculptGuide_spacing = {
	...
	GPencilSculptGuide_spacing_get, GPencilSculptGuide_spacing_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 1.0f, 3, 20.0f, NULL
};
...
StructRNA RNA_GPencilSculptSettings = {
	{(ContainerRNA *)&RNA_SequenceColorBalanceData, (ContainerRNA *)&RNA_GPencilSculptGuide,
	NULL,
