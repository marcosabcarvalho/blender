...
{
    extern int WorkSpaceTool_idname_fallback_length(PointerRNA *);
    extern void WorkSpaceTool_idname_fallback_get(PointerRNA *, char *);
    ...
    while (iter.valid) {
        if (iter.ptr.data) {
            int namelen = WorkSpaceTool_idname_fallback_length(&iter.ptr);
            if (namelen < 1024) {
                WorkSpaceTool_idname_fallback_get(&iter.ptr, namebuf);
                if (strcmp(namebuf, key) == 0) {
                    found = true;
                    *r_ptr = iter.ptr;
                    break;
                ...
                name = MEM_mallocN(namelen+1, "name string");
                WorkSpaceTool_idname_fallback_get(&iter.ptr, name);
                if (strcmp(name, key) == 0) {
                    MEM_freeN(name);
...
void WorkSpaceTool_setup_func(struct ID *_selfid, struct bToolRef *_self, bContext *C, const char * idname, int cursor, const char * keymap, const char * gizmo_group, const char * data_block, const char * operator_value, int index, const char * idname_fallback, const char * keymap_fallback)
{
	rna_WorkSpaceTool_setup(_selfid, _self, C, idname, cursor, keymap, gizmo_group, data_block, operator_value, index, idname_fallback, keymap_fallback);
}
...
void WorkSpaceTool_setup_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_WorkSpaceTool_setup(_selfid, _self, C, idname, cursor, keymap, gizmo_group, data_block, operator, index, idname_fallback, keymap_fallback);
}
...
void rna_WorkSpaceTool_setup(struct ID *_selfid, struct bToolRef *_self, bContext *C, const char * idname, int cursor, const char * keymap, const char * gizmo_group, const char * data_block, const char * operator_value, int index, const char * idname_fallback, const char * keymap_fallback);
...
StringPropertyRNA rna_WorkSpaceTool_idname_fallback = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WorkSpaceTool_idname_fallback_get, WorkSpaceTool_idname_fallback_length, WorkSpaceTool_idname_fallback_set, NULL, NULL, NULL, 64, ""
};
...
static const EnumPropertyItem rna_WorkSpaceTool_setup_cursor_items[18] = {
	{1, "DEFAULT", 0, "Default", ""},
	{34, "NONE", 0, "None", ""},
	{3, "WAIT", 0, "Wait", ""},
...
EnumPropertyRNA rna_WorkSpaceTool_setup_cursor = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_WorkSpaceTool_setup_cursor_items, 17, 1
};
...
IntPropertyRNA rna_WorkSpaceTool_setup_index = {
	{(PropertyRNA *)&rna_WorkSpaceTool_setup_idname_fallback, (PropertyRNA *)&rna_WorkSpaceTool_setup_operator,
...
StringPropertyRNA rna_WorkSpaceTool_setup_idname_fallback = {
	{(PropertyRNA *)&rna_WorkSpaceTool_setup_keymap_fallback, (PropertyRNA *)&rna_WorkSpaceTool_setup_index,
...
StructRNA RNA_WorkSpaceTool = {
	...
	"",
	"*", 17,
	(PropertyRNA *)&rna_WorkSpaceTool_idname_fallback, (PropertyRNA *)&rna_WorkSpaceTool_rna_properties,
	NULL,
	NULL,
	NULL,
	NULL,
...
static const EnumPropertyItem rna_WorkSpace_object_mode_items[14] = {
	...
	{2048, "VERTEX_GPENCIL", 133, "Grease Pencil Vertex Paint", "Grease Pencil Vertex Paint Strokes"},
	{1024, "WEIGHT_GPENCIL", 135, "Grease Pencil Weight Paint", "Grease Pencil Weight Paint Strokes"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_WorkSpace_object_mode = {
	{(PropertyRNA *)&rna_WorkSpace_use_filter_by_owner, (PropertyRNA *)&rna_WorkSpace_tools,
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WorkSpace_object_mode_get, WorkSpace_object_mode_set, NULL, NULL, NULL, NULL, rna_WorkSpace_object_mode_items, 13, 0
};
...
static const EnumPropertyItem rna_wmTools_from_space_view3d_mode_mode_items[20] = {
	...
	{18, "VERTEX_GPENCIL", 0, "Grease Pencil Vertex Paint", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_wmTools_from_space_view3d_mode_mode = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_wmTools_from_space_view3d_mode_mode_items, 19, 0
};
...
static const EnumPropertyItem rna_wmTools_from_space_sequencer_mode_items[4] = {
...
EnumPropertyRNA rna_wmTools_from_space_sequencer_mode = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_wmTools_from_space_sequencer_mode_items, 3, 1
};
