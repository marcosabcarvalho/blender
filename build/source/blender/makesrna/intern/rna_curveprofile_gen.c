...
FloatPropertyRNA rna_CurveProfilePoint_location = {
	...
	NULL, NULL, CurveProfilePoint_location_get, CurveProfilePoint_location_set, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_CurveProfilePoint_location_default
};

static const EnumPropertyItem rna_CurveProfilePoint_handle_type_1_items[3] = {
	{1, "AUTO", 0, "Auto Handle", ""},
...
EnumPropertyRNA rna_CurveProfilePoint_handle_type_1 = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CurveProfilePoint_handle_type_1_get, CurveProfilePoint_handle_type_1_set, NULL, NULL, NULL, NULL, rna_CurveProfilePoint_handle_type_1_items, 2, 1
};

static const EnumPropertyItem rna_CurveProfilePoint_handle_type_2_items[3] = {
	{1, "AUTO", 0, "Auto Handle", ""},
	{2, "VECTOR", 0, "Vector Handle", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_CurveProfilePoint_handle_type_2 = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CurveProfilePoint_handle_type_2_get, CurveProfilePoint_handle_type_2_set, NULL, NULL, NULL, NULL, rna_CurveProfilePoint_handle_type_2_items, 2, 1
};
...
EnumPropertyRNA rna_CurveProfile_preset = {
	...
	-1, "preset", 3, 0, 0, 0, 0, "Preset",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CurveProfile_preset_get, CurveProfile_preset_set, NULL, NULL, NULL, NULL, rna_CurveProfile_preset_items, 5, 0
};
...
FunctionRNA rna_CurveProfile_update_func = {
	{(FunctionRNA *)&rna_CurveProfile_initialize_func, NULL,
	NULL,
	{NULL, NULL}},
	"update", 0, "Update the profile",
...
IntPropertyRNA rna_CurveProfile_initialize_totsegments = {
	...
	1, 100, 1, 1000, 1, 1, NULL
};

FunctionRNA rna_CurveProfile_initialize_func = {
	{(FunctionRNA *)&rna_CurveProfile_evaluate_func, (FunctionRNA *)&rna_CurveProfile_update_func,
	NULL,
...
FloatPropertyRNA rna_CurveProfile_evaluate_location = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -100.0f, 100.0f, -100.0f, 100.0f, 1.0f, 3, 0.0f, rna_CurveProfile_evaluate_location_default
};
