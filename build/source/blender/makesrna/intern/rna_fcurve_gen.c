...
static const EnumPropertyItem rna_FCurve_auto_smoothing_items[3] = {
	{0, "NONE", 0, "None", "Automatic handles only take immediately adjacent keys into account"},
	{1, "CONT_ACCEL", 0, "Continuous Acceleration", "Automatic handles are adjusted to avoid jumps in acceleration, resulting in smoother curves. However, key changes may affect interpolation over a larger stretch of the curve"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_Keyframe_handle_left_type_items[6] = {
	{0, "FREE", 771, "Free", "Completely independent manually set handle"},
	{3, "ALIGNED", 769, "Aligned", "Manually set handle with rotation locked together with its pair"},
	{2, "VECTOR", 770, "Vector", "Automatic handles that create straight lines"},
	{1, "AUTO", 768, "Automatic", "Automatic handles that create smooth curves"},
	{4, "AUTO_CLAMPED", 767, "Auto Clamped", "Automatic handles that create smooth curves which only change direction at keyframes"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_DriverTarget_id_type_items[36] = {
...
EnumPropertyRNA rna_DriverTarget_id_type = {
	...
	0, -1, NULL},
	DriverTarget_id_type_get, DriverTarget_id_type_set, NULL, NULL, NULL, NULL, rna_DriverTarget_id_type_items, 35, 16975
};
...
EnumPropertyRNA rna_DriverTarget_transform_type = {
	...
	rna_DriverTarget_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	DriverTarget_transform_type_get, DriverTarget_transform_type_set, NULL, NULL, NULL, NULL, rna_DriverTarget_transform_type_items, 13, 0
};

static const EnumPropertyItem rna_DriverTarget_rotation_mode_items[12] = {
...
EnumPropertyRNA rna_DriverTarget_rotation_mode = {
	...
	rna_DriverTarget_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	DriverTarget_rotation_mode_get, DriverTarget_rotation_mode_set, NULL, NULL, NULL, NULL, rna_DriverTarget_rotation_mode_items, 11, 0
};
