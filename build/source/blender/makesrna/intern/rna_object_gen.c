...
extern PointerPropertyRNA rna_Object_generate_gpencil_strokes_ob_gpencil;
extern BoolPropertyRNA rna_Object_generate_gpencil_strokes_gpencil_lines;
...
bool Object_generate_gpencil_strokes_func(struct Object *_self, bContext *C, ReportList *reports, struct Object *ob_gpencil, bool gpencil_lines, bool use_collections)
{
	return rna_Object_generate_gpencil_strokes(_self, C, reports, ob_gpencil, gpencil_lines, use_collections);
}

void Object_generate_gpencil_strokes_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct Object *_self;
	struct Object *ob_gpencil;
	bool gpencil_lines;
	...
	_self = (struct Object *)_ptr->data;
	_data = (char *)_parms->data;
	ob_gpencil = *((struct Object **)_data);
	_data += 8;
	gpencil_lines = *((bool *)_data);
	_data += 1;
	use_collections = *((bool *)_data);
	_data += 1;
	_retdata = _data;
	
	result = rna_Object_generate_gpencil_strokes(_self, C, reports, ob_gpencil, gpencil_lines, use_collections);
	*((bool *)_retdata) = result;
}
...
bool rna_Object_generate_gpencil_strokes(struct Object *_self, bContext *C, ReportList *reports, struct Object *ob_gpencil, bool gpencil_lines, bool use_collections);
...
struct bDeformGroup *VertexGroups_new_func(struct Object *_self, Main *bmain, const char * name)
{
	return rna_Object_vgroup_new(_self, bmain, name);
}
...
void VertexGroups_new_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	group = rna_Object_vgroup_new(_self, CTX_data_main(C), name);
...
void VertexGroups_clear_func(struct Object *_self, Main *bmain)
{
	rna_Object_vgroup_clear(_self, bmain);
}
...
void VertexGroups_clear_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_Object_vgroup_clear(_self, CTX_data_main(C));
}

/* Repeated prototypes to detect errors */

struct bDeformGroup *rna_Object_vgroup_new(struct Object *_self, Main *bmain, const char * name);
void rna_Object_vgroup_remove(struct Object *_self, Main *bmain, ReportList *reports, struct PointerRNA *group);
void rna_Object_vgroup_clear(struct Object *_self, Main *bmain);
...
PointerPropertyRNA rna_Object_data = {
	...
	rna_Object_internal_update_data_dependency, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Object_data_get, Object_data_set, rna_Object_data_typef, rna_Object_data_poll,&RNA_ID
};

static const EnumPropertyItem rna_Object_type_items[17] = {
	{1, "MESH", 0, "Mesh", ""},
	{2, "CURVE", 0, "Curve", ""},
	{3, "SURFACE", 0, "Surface", ""},
	{5, "META", 0, "Meta", ""},
...
EnumPropertyRNA rna_Object_type = {
	...
	0, -1, NULL},
	Object_type_get, NULL, NULL, NULL, NULL, NULL, rna_Object_type_items, 16, 0
};

static const EnumPropertyItem rna_Object_mode_items[14] = {
	...
	{2048, "VERTEX_GPENCIL", 133, "Vertex Paint", "Grease Pencil Vertex Paint Strokes"},
...
EnumPropertyRNA rna_Object_mode = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Object_mode_get, NULL, NULL, NULL, NULL, NULL, rna_Object_mode_items, 13, 0
};
...
PointerPropertyRNA rna_Object_parent = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Object_dependency_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_Object_parent_override_apply,
	0, -1, NULL},
...
PointerPropertyRNA rna_Object_proxy_collection = {
	...
	-1, "proxy_collection", 8388736, 2, 0, 0, 0, "Proxy Collection",
...
EnumPropertyRNA rna_Object_rotation_mode = {
	...
	0, -1, NULL},
	Object_rotation_mode_get, Object_rotation_mode_set, NULL, NULL, NULL, NULL, rna_Object_rotation_mode_items, 8, 1
};
...
FloatPropertyRNA rna_Object_empty_display_size = {
	...
	Object_empty_display_size_get, Object_empty_display_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 100.0f, 0.0001000000f, 1000.0f, 1.0f, 2, 1.0f, NULL
};
...
BoolPropertyRNA rna_Object_show_empty_image_only_axis_aligned = {
	...
	-1, "show_empty_image_only_axis_aligned", 3, 0, 0, 0, 0, "Display Only Axis Aligned",
...
FloatPropertyRNA rna_Object_color = {
	...
	rna_Object_internal_update_draw, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
BoolPropertyRNA rna_Object_show_instancer_for_render = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Object_duplicator_visibility_flag_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FloatPropertyRNA rna_Object_instance_faces_scale = {
	...
	Object_instance_faces_scale_get, Object_instance_faces_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 10000.0f, 0.0010000000f, 10000.0f, 10.0f, 3, 1.0f, NULL
};
...
EnumPropertyRNA rna_Object_display_type = {
	...
	rna_Object_internal_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Object_display_type_get, Object_display_type_set, NULL, NULL, NULL, NULL, rna_Object_display_type_items, 4, 5
};
...
BoolPropertyRNA rna_Object_use_grease_pencil_lights = {
	...
	-1, "use_grease_pencil_lights", 1, 0, 0, 0, 0, "Use Lights",
	"Lights affect grease pencil object",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_GPencil_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
IntPropertyRNA rna_Object_active_shape_key_index = {
	...
	-1, "active_shape_key_index", 1, 0, 0, 0, 0, "Active Shape Key Index",
...
FunctionRNA rna_Object_to_mesh_func = {
	{(FunctionRNA *)&rna_Object_to_mesh_clear_func, (FunctionRNA *)&rna_Object_camera_fit_coords_func,
	NULL,
...
FunctionRNA rna_Object_to_mesh_clear_func = {
	{(FunctionRNA *)&rna_Object_find_armature_func, (FunctionRNA *)&rna_Object_to_mesh_func,
	NULL,
	{NULL, NULL}},
...
FunctionRNA rna_Object_find_armature_func = {
	{(FunctionRNA *)&rna_Object_shape_key_add_func, (FunctionRNA *)&rna_Object_to_mesh_clear_func,
	NULL,
...
PointerPropertyRNA rna_Object_generate_gpencil_strokes_ob_gpencil = {
	{(PropertyRNA *)&rna_Object_generate_gpencil_strokes_gpencil_lines, NULL,
	-1, "ob_gpencil", 8650880, 0, 1, 0, 0, "",
...
BoolPropertyRNA rna_Object_generate_gpencil_strokes_gpencil_lines = {
	{(PropertyRNA *)&rna_Object_generate_gpencil_strokes_use_collections, (PropertyRNA *)&rna_Object_generate_gpencil_strokes_ob_gpencil,
	-1, "gpencil_lines", 3, 0, 0, 0, 0, "",
	"Create Lines",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
BoolPropertyRNA rna_Object_generate_gpencil_strokes_use_collections = {
	{(PropertyRNA *)&rna_Object_generate_gpencil_strokes_result, (PropertyRNA *)&rna_Object_generate_gpencil_strokes_gpencil_lines,
...
BoolPropertyRNA rna_Object_generate_gpencil_strokes_result = {
	{NULL, (PropertyRNA *)&rna_Object_generate_gpencil_strokes_use_collections,
	-1, "result", 3, 0, 2, 0, 0, "",
	"Result",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FunctionRNA rna_Object_generate_gpencil_strokes_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_Object_generate_gpencil_strokes_ob_gpencil, (PropertyRNA *)&rna_Object_generate_gpencil_strokes_result}},
...
static const EnumPropertyItem rna_ObjectGpencilModifiers_new_type_items[21] = {
	{0, "", 0, "Generate", ""},
...
EnumPropertyRNA rna_ObjectGpencilModifiers_new_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_ObjectGpencilModifiers_new_type_items, 20, 1
};
...
static const EnumPropertyItem rna_ObjectShaderFx_new_type_items[10] = {
...
EnumPropertyRNA rna_ObjectShaderFx_new_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_ObjectShaderFx_new_type_items, 9, 1
};
...
static const EnumPropertyItem rna_ObjectConstraints_new_type_items[33] = {
	{0, "", 0, "Motion Tracking", ""},
	{27, "CAMERA_SOLVER", 416, "Camera Solver", ""},
	{26, "FOLLOW_TRACK", 417, "Follow Track", ""},
	{28, "OBJECT_SOLVER", 418, "Object Solver", ""},
	{0, "", 0, "Transform", ""},
	{9, "COPY_LOCATION", 419, "Copy Location", "Copy the location of a target (with an optional offset), so that they move together"},
	{8, "COPY_ROTATION", 420, "Copy Rotation", "Copy the rotation of a target (with an optional offset), so that they rotate together"},
	{10, "COPY_SCALE", 421, "Copy Scale", "Copy the scale factors of a target (with an optional offset), so that they are scaled by the same amount"},
	{23, "COPY_TRANSFORMS", 422, "Copy Transforms", "Copy all the transformations of a target, so that they move together"},
	{14, "LIMIT_DISTANCE", 423, "Limit Distance", "Restrict movements to within a certain distance of a target (at the time of constraint evaluation only)"},
	{6, "LIMIT_LOCATION", 424, "Limit Location", "Restrict movement along each axis within given ranges"},
	{5, "LIMIT_ROTATION", 425, "Limit Rotation", "Restrict rotation along each axis within given ranges"},
	{7, "LIMIT_SCALE", 426, "Limit Scale", "Restrict scaling along each axis with given ranges"},
	{24, "MAINTAIN_VOLUME", 427, "Maintain Volume", "Compensate for scaling one axis by applying suitable scaling to the other two axes"},
	{19, "TRANSFORM", 428, "Transformation", "Use one transform property from target to control another (or same) property on owner"},
	{29, "TRANSFORM_CACHE", 429, "Transform Cache", "Look up the transformation matrix from an external file"},
	{0, "", 0, "Tracking", ""},
	{18, "CLAMP_TO", 430, "Clamp To", "Restrict movements to lie along a curve by remapping location along curve\'s longest axis"},
	{21, "DAMPED_TRACK", 435, "Damped Track", "Point towards a target by performing the smallest rotation necessary"},
	{3, "IK", 431, "Inverse Kinematics", "Control a chain of bones by specifying the endpoint target (Bones only)"},
	{13, "LOCKED_TRACK", 432, "Locked Track", "Rotate around the specified (\'locked\') axis to point towards a target"},
	{22, "SPLINE_IK", 433, "Spline IK", "Align chain of bones along a curve (Bones only)"},
	{15, "STRETCH_TO", 434, "Stretch To", "Stretch along Y-Axis to point towards a target"},
	{2, "TRACK_TO", 435, "Track To", "Legacy tracking constraint prone to twisting artifacts"},
	{0, "", 0, "Relationship", ""},
	{12, "ACTION", 115, "Action", "Use transform property of target to look up pose for owner from an Action"},
	{30, "ARMATURE", 436, "Armature", "Apply weight-blended transformation from multiple bones like the Armature modifier"},
	{1, "CHILD_OF", 437, "Child Of", "Make target the \'detachable\' parent of owner"},
	{16, "FLOOR", 438, "Floor", "Use position (and optionally rotation) of target to define a \'wall\' or \'floor\' that the owner can not cross"},
	{4, "FOLLOW_PATH", 439, "Follow Path", "Use to animate an object/bone following a path"},
	{25, "PIVOT", 440, "Pivot", "Change pivot point for transforms (buggy)"},
	{20, "SHRINKWRAP", 441, "Shrinkwrap", "Restrict movements to surface of target mesh"},
	{0, NULL, 0, NULL, NULL}
};
...
IntPropertyRNA rna_ObjectConstraints_move_from_index = {
	...
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 10000, INT_MIN, INT_MAX, 1, -1, NULL
};
...
FunctionRNA rna_ObjectConstraints_move_func = {
	{NULL, (FunctionRNA *)&rna_ObjectConstraints_clear_func,
	NULL,
...
StructRNA RNA_ObjectConstraints = {
	...
	NULL,
	NULL,
	{(FunctionRNA *)&rna_ObjectConstraints_new_func, (FunctionRNA *)&rna_ObjectConstraints_move_func}
};
...
PointerPropertyRNA rna_VertexGroups_active = {
	...
	-1, "active", 8388609, 0, 0, 0, 0, "Active Vertex Group",
	"Vertex groups of the object",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FunctionRNA rna_VertexGroups_new_func = {
	...
	"new", 4, "Add vertex group to object",
...
FunctionRNA rna_VertexGroups_clear_func = {
	...
	NULL,
	{NULL, NULL}},
	"clear", 4, "Delete all vertex groups from object",
...
StringPropertyRNA rna_VertexGroup_name = {
	...
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Object_internal_update_data_dependency, 274399237, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
