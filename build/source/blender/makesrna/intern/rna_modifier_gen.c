...
BoolPropertyRNA rna_BevelModifier_use_custom_profile;
...
IntPropertyRNA rna_WeldModifier_max_interactions;
...
bool BevelModifier_use_custom_profile_get(PointerRNA *ptr)
{
    BevelModifierData *data = (BevelModifierData *)(ptr->data);
    return (((data->flags) & 128) != 0);
}

void BevelModifier_use_custom_profile_set(PointerRNA *ptr, bool value)
{
    BevelModifierData *data = (BevelModifierData *)(ptr->data);
...
{
    OceanModifierData *data = (OceanModifierData *)(ptr->data);
    data->sharpen_peak_jonswap = CLAMPIS(value, 0.0f, 10.0f);
}
...
int WeldModifier_max_interactions_get(PointerRNA *ptr)
{
    WeldModifierData *data = (WeldModifierData *)(ptr->data);
    return (int)(data->max_interactions);
}

void WeldModifier_max_interactions_set(PointerRNA *ptr, int value)
{
    WeldModifierData *data = (WeldModifierData *)(ptr->data);
    data->max_interactions = CLAMPIS(value, 0, INT_MAX);
    { BLI_STATIC_ASSERT((TYPEOF_MAX(data->max_interactions) >= 2147483647) && (TYPEOF_MIN(data->max_interactions) <= 0), "invalid limits"); }
}
...
static const EnumPropertyItem rna_Modifier_type_items[58] = {
	{0, "", 0, "Modify", ""},
	{49, "DATA_TRANSFER", 483, "Data Transfer", "Transfer several types of data (vertex groups, UV maps, vertex colors, custom normals) from one mesh to another"},
	{46, "MESH_CACHE", 463, "Mesh Cache", "Deform the mesh using an external frame-by-frame vertex transform cache"},
	{52, "MESH_SEQUENCE_CACHE", 463, "Mesh Sequence Cache", "Deform the mesh or curve using an external mesh cache in Alembic format"},
	{50, "NORMAL_EDIT", 484, "Normal Edit", "Modify the direction of the surface normals"},
	{54, "WEIGHTED_NORMAL", 484, "Weighted Normal", "Modify the direction of the surface normals using a weighting method"},
	{15, "UV_PROJECT", 455, "UV Project", "Project the UV map coordinates from the negative Z axis of another object"},
	{45, "UV_WARP", 455, "UV Warp", "Transform the UV map using the difference between two objects"},
	{36, "VERTEX_WEIGHT_EDIT", 475, "Vertex Weight Edit", "Modify of the weights of a vertex group"},
	{37, "VERTEX_WEIGHT_MIX", 475, "Vertex Weight Mix", "Mix the weights of two vertex groups"},
	{38, "VERTEX_WEIGHT_PROXIMITY", 475, "Vertex Weight Proximity", "Set the vertex group weights based on the distance to another target object"},
	{0, "", 0, "Generate", ""},
	{12, "ARRAY", 454, "Array", "Create copies of the shape with offsets"},
	{24, "BEVEL", 464, "Bevel", "Generate sloped corners by adding geometry to the mesh\'s edges or vertices"},
	{11, "BOOLEAN", 452, "Boolean", "Use another shape to cut, combine or perform a difference operation"},
	{4, "BUILD", 444, "Build", "Cause the faces of the mesh object to appear or disappear one after the other over time"},
	{6, "DECIMATE", 445, "Decimate", "Reduce the geometry density"},
	{13, "EDGE_SPLIT", 453, "Edge Split", "Split away joined faces at the edges"},
	{27, "MASK", 467, "Mask", "Dynamically hide vertices based on a vertex group or armature"},
	{5, "MIRROR", 446, "Mirror", "Mirror along the local X, Y and/or Z axes, over the object origin"},
	{29, "MULTIRES", 471, "Multiresolution", "Subdivide the mesh in a way that allows editing the higher subdivision levels"},
	{41, "REMESH", 477, "Remesh", "Generate new mesh topology based on the current shape"},
	{34, "SCREW", 474, "Screw", "Lathe around an axis, treating the input mesh as a profile"},
	{42, "SKIN", 480, "Skin", "Create a solid shape from vertices and edges, using the vertex radius to define the thickness"},
	{33, "SOLIDIFY", 473, "Solidify", " Make the surface thick"},
	{1, "SUBSURF", 448, "Subdivision Surface", "Split the faces into smaller parts, giving it a smoother appearance"},
	{44, "TRIANGULATE", 481, "Triangulate", "Convert all polygons to triangles"},
	{55, "WELD", 607, "Weld", "Find groups of vertices closer then dist and merges them together"},
	{48, "WIREFRAME", 482, "Wireframe", "Convert faces into thickened edges"},
	{0, "", 0, "Deform", ""},
	{8, "ARMATURE", 460, "Armature", "Deform the shape using an armature object"},
	{17, "CAST", 462, "Cast", "Shift the shape towards a predefined primitive"},
	{3, "CURVE", 457, "Curve", "Bend the mesh using a curve object"},
	{14, "DISPLACE", 456, "Displace", "Offset vertices based on a texture"},
	{9, "HOOK", 449, "Hook", "Deform specific points using another object"},
	{47, "LAPLACIANDEFORM", 463, "Laplacian Deform", "Deform based a series of anchor points"},
	{2, "LATTICE", 458, "Lattice", "Deform using the shape of a lattice object"},
	{18, "MESH_DEFORM", 463, "Mesh Deform", "Deform using a different mesh, which acts as a deformation cage"},
	{25, "SHRINKWRAP", 461, "Shrinkwrap", "Project the shape onto another object"},
	{28, "SIMPLE_DEFORM", 466, "Simple Deform", "Deform the shape by twisting, bending, tapering or stretching"},
	{16, "SMOOTH", 465, "Smooth", "Smooth the mesh by flattening the angles between adjacent faces"},
	{51, "CORRECTIVE_SMOOTH", 465, "Smooth Corrective", "Smooth the mesh while still preserving the volume"},
	{43, "LAPLACIANSMOOTH", 465, "Smooth Laplacian", "Reduce the noise on a mesh surface with minimal changes to its shape"},
	{53, "SURFACE_DEFORM", 463, "Surface Deform", "Transfer motion from another mesh"},
	{35, "WARP", 479, "Warp", "Warp parts of a mesh to a new location in a very flexible way thanks to 2 specified objects"},
	{7, "WAVE", 443, "Wave", "Adds a ripple-like motion to an object’s geometry"},
	{0, "", 0, "Simulate", ""},
	{22, "CLOTH", 468, "Cloth", ""},
	{23, "COLLISION", 450, "Collision", ""},
	{40, "DYNAMIC_PAINT", 476, "Dynamic Paint", ""},
	{21, "EXPLODE", 469, "Explode", "Break apart the mesh faces and let them follow particles"},
	{56, "FLUID", 470, "Fluid", ""},
	{39, "OCEAN", 478, "Ocean", "Generate a moving ocean surface"},
	{20, "PARTICLE_INSTANCE", 485, "Particle Instance", ""},
	{19, "PARTICLE_SYSTEM", 451, "Particle System", "Spawn particles from the shape"},
...
BoolPropertyRNA rna_MirrorModifier_use_mirror_udim = {
	...
	-1, "use_mirror_udim", 3, 0, 0, 0, 0, "Mirror UDIM",
...
StringPropertyRNA rna_WaveModifier_texture_coords_bone = {
	...
	-1, "texture_coords_bone", 262145, 0, 0, 0, 0, "Texture Coordinate Bone",
	"Bone to set the texture coordinates",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WaveModifier_texture_coords_bone_get, WaveModifier_texture_coords_bone_length, WaveModifier_texture_coords_bone_set, NULL, NULL, NULL, 64, ""
};
...
BoolPropertyRNA rna_ArmatureModifier_use_bone_envelopes = {
	...
	-1, "use_bone_envelopes", 1, 0, 0, 0, 0, "Use Bone Envelopes",
...
BoolPropertyRNA rna_ArmatureModifier_use_vertex_groups = {
	...
	-1, "use_vertex_groups", 1, 0, 0, 0, 0, "Use Vertex Groups",
...
IntPropertyRNA rna_HookModifier_vertex_indices = {
	...
	-1, "vertex_indices", 131074, 0, 0, 0, 0, "Vertex Indices",
	...
	0, 10000, 0, INT_MAX, 1, 0, rna_HookModifier_vertex_indices_default
};
...
IntPropertyRNA rna_HookModifier_vertex_indices_set_indices = {
	...
	0, INT_MAX, INT_MIN, INT_MAX, 1, 0, rna_HookModifier_vertex_indices_set_indices_default
};
...
StringPropertyRNA rna_DisplaceModifier_texture_coords_bone = {
	...
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	DisplaceModifier_texture_coords_bone_get, DisplaceModifier_texture_coords_bone_length, DisplaceModifier_texture_coords_bone_set, NULL, NULL, NULL, 64, ""
};
...
FloatPropertyRNA rna_CorrectiveSmoothModifier_scale = {
	...
	CorrectiveSmoothModifier_scale_get, CorrectiveSmoothModifier_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, -FLT_MAX, FLT_MAX, 5.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_BevelModifier_offset_type = {
	...
	-1, "offset_type", 3, 0, 0, 0, 0, "Width Type",
...
EnumPropertyRNA rna_BevelModifier_miter_inner = {
	...
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BevelModifier_miter_inner_get, BevelModifier_miter_inner_set, NULL, NULL, NULL, NULL, rna_BevelModifier_miter_inner_items, 2, 0
};

FloatPropertyRNA rna_BevelModifier_spread = {
	{(PropertyRNA *)&rna_BevelModifier_use_custom_profile, (PropertyRNA *)&rna_BevelModifier_miter_inner,
...
BoolPropertyRNA rna_BevelModifier_use_custom_profile = {
	{(PropertyRNA *)&rna_BevelModifier_custom_profile, (PropertyRNA *)&rna_BevelModifier_spread,
	-1, "use_custom_profile", 3, 0, 0, 0, 0, "Custom Profile",
	"Whether to use a user inputted curve for the bevel\'s profile",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BevelModifier_use_custom_profile_get, BevelModifier_use_custom_profile_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_BevelModifier_custom_profile = {
	{(PropertyRNA *)&rna_BevelModifier_vmesh_method, (PropertyRNA *)&rna_BevelModifier_use_custom_profile,
	-1, "custom_profile", 8388608, 0, 0, 0, 0, "Custom Profile Path",
...
EnumPropertyRNA rna_BevelModifier_vmesh_method = {
	...
	-1, "vmesh_method", 3, 0, 0, 0, 0, "Vertex Mesh Method",
	"The method to use to create the mesh at intersections",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BevelModifier_vmesh_method_get, BevelModifier_vmesh_method_set, NULL, NULL, NULL, NULL, rna_BevelModifier_vmesh_method_items, 2, 0
};
...
StringPropertyRNA rna_WarpModifier_bone_from = {
	...
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WarpModifier_bone_from_get, WarpModifier_bone_from_length, WarpModifier_bone_from_set, NULL, NULL, NULL, 64, ""
};
...
StringPropertyRNA rna_WarpModifier_bone_to = {
	...
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WarpModifier_bone_to_get, WarpModifier_bone_to_length, WarpModifier_bone_to_set, NULL, NULL, NULL, 64, ""
};
...
StringPropertyRNA rna_WarpModifier_texture_coords_bone = {
	...
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WarpModifier_texture_coords_bone_get, WarpModifier_texture_coords_bone_length, WarpModifier_texture_coords_bone_set, NULL, NULL, NULL, 64, ""
};
...
PointerPropertyRNA rna_FluidModifier_effector_settings = {
	...
	-1, "effector_settings", 8388608, 0, 0, 0, 0, "Effector Settings",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
EnumPropertyRNA rna_FluidModifier_fluid_type = {
	...
	0, -1, NULL},
	FluidModifier_fluid_type_get, FluidModifier_fluid_type_set, NULL, NULL, NULL, NULL, rna_FluidModifier_fluid_type_items, 4, 0
};
...
EnumPropertyRNA rna_SolidifyModifier_solidify_mode = {
	...
	-1, "solidify_mode", 3, 0, 0, 0, 0, "Mode",
	"Selects the used algorithm",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SolidifyModifier_solidify_mode_get, SolidifyModifier_solidify_mode_set, NULL, NULL, NULL, NULL, rna_SolidifyModifier_solidify_mode_items, 2, 0
};
...
BoolPropertyRNA rna_SolidifyModifier_use_thickness_angle_clamp = {
	...
	-1, "use_thickness_angle_clamp", 3, 0, 0, 0, 0, "Angle Clamp",
...
StringPropertyRNA rna_SolidifyModifier_shell_vertex_group = {
	...
	-1, "shell_vertex_group", 262145, 0, 0, 0, 0, "Shell Vertex Group",
	"Vertex group that the generated shell geometry will be weighted to",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SolidifyModifier_shell_vertex_group_get, SolidifyModifier_shell_vertex_group_length, SolidifyModifier_shell_vertex_group_set, NULL, NULL, NULL, 64, ""
};

StringPropertyRNA rna_SolidifyModifier_rim_vertex_group = {
	{(PropertyRNA *)&rna_SolidifyModifier_use_rim, (PropertyRNA *)&rna_SolidifyModifier_shell_vertex_group,
	-1, "rim_vertex_group", 262145, 0, 0, 0, 0, "Rim Vertex Group",
	"Vertex group that the generated rim geometry will be weighted to",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SolidifyModifier_rim_vertex_group_get, SolidifyModifier_rim_vertex_group_length, SolidifyModifier_rim_vertex_group_set, NULL, NULL, NULL, 64, ""
};
...
BoolPropertyRNA rna_SolidifyModifier_use_flat_faces = {
	...
	-1, "use_flat_faces", 3, 0, 0, 0, 0, "Flat Faces",
...
EnumPropertyRNA rna_SolidifyModifier_nonmanifold_thickness_mode = {
	...
	-1, "nonmanifold_thickness_mode", 3, 0, 0, 0, 0, "Thickness Mode",
	"Selects the used thickness algorithm",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SolidifyModifier_nonmanifold_thickness_mode_get, SolidifyModifier_nonmanifold_thickness_mode_set, NULL, NULL, NULL, NULL, rna_SolidifyModifier_nonmanifold_thickness_mode_items, 3, 0
};
...
EnumPropertyRNA rna_SolidifyModifier_nonmanifold_boundary_mode = {
	...
	-1, "nonmanifold_boundary_mode", 3, 0, 0, 0, 0, "Boundary Shape",
	"Selects the boundary adjustment algorithm",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SolidifyModifier_nonmanifold_boundary_mode_get, SolidifyModifier_nonmanifold_boundary_mode_set, NULL, NULL, NULL, NULL, rna_SolidifyModifier_nonmanifold_boundary_mode_items, 3, 0
};

FloatPropertyRNA rna_SolidifyModifier_nonmanifold_merge_threshold = {
	{(PropertyRNA *)&rna_SolidifyModifier_bevel_convex, (PropertyRNA *)&rna_SolidifyModifier_nonmanifold_boundary_mode,
	-1, "nonmanifold_merge_threshold", 3, 0, 0, 4, 0, "Merge Threshold",
	"Distance within which degenerated geometry is merged",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(SolidifyModifierData, merge_tolerance), 5, NULL},
	SolidifyModifier_nonmanifold_merge_threshold_get, SolidifyModifier_nonmanifold_merge_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 0.0099999998f, 4, 0.0f, NULL
};

FloatPropertyRNA rna_SolidifyModifier_bevel_convex = {
	{NULL, (PropertyRNA *)&rna_SolidifyModifier_nonmanifold_merge_threshold,
	-1, "bevel_convex", 3, 0, 0, 4, 0, "Bevel Convex",
	"Edge bevel weight to be added to outside edges",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(SolidifyModifierData, bevel_convex), 5, NULL},
	SolidifyModifier_bevel_convex_get, SolidifyModifier_bevel_convex_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -1.0f, 1.0f, -1.0f, 1.0f, 0.1000000015f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_UVWarpModifier_offset = {
	...
	NULL, NULL, UVWarpModifier_offset_get, UVWarpModifier_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_UVWarpModifier_offset_default
};
...
FloatPropertyRNA rna_UVWarpModifier_scale = {
	...
	NULL, NULL, UVWarpModifier_scale_get, UVWarpModifier_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_UVWarpModifier_scale_default
};
...
FloatPropertyRNA rna_UVWarpModifier_rotation = {
	...
	UVWarpModifier_rotation_get, UVWarpModifier_rotation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_VertexWeightEditModifier_invert_falloff = {
	{(PropertyRNA *)&rna_VertexWeightEditModifier_map_curve, (PropertyRNA *)&rna_VertexWeightEditModifier_falloff_type,
	-1, "invert_falloff", 3, 0, 0, 0, 0, "Invert Falloff",
...
PointerPropertyRNA rna_VertexWeightEditModifier_map_curve = {
	{(PropertyRNA *)&rna_VertexWeightEditModifier_use_add, (PropertyRNA *)&rna_VertexWeightEditModifier_invert_falloff,
...
StringPropertyRNA rna_VertexWeightEditModifier_mask_tex_map_bone = {
	{(PropertyRNA *)&rna_VertexWeightEditModifier_invert_mask_vertex_group, (PropertyRNA *)&rna_VertexWeightEditModifier_mask_tex_map_object,
	-1, "mask_tex_map_bone", 262145, 0, 0, 0, 0, "Texture Coordinate Bone",
	"Which bone to take texture coordinates from",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	VertexWeightEditModifier_mask_tex_map_bone_get, VertexWeightEditModifier_mask_tex_map_bone_length, VertexWeightEditModifier_mask_tex_map_bone_set, NULL, NULL, NULL, 64, ""
};

BoolPropertyRNA rna_VertexWeightEditModifier_invert_mask_vertex_group = {
	{NULL, (PropertyRNA *)&rna_VertexWeightEditModifier_mask_tex_map_bone,
	-1, "invert_mask_vertex_group", 3, 0, 0, 0, 0, "Invert",
...
StructRNA RNA_VertexWeightEditModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_VertexWeightEditModifier_vertex_group, (PropertyRNA *)&rna_VertexWeightEditModifier_invert_mask_vertex_group}},
...
StringPropertyRNA rna_VertexWeightMixModifier_mask_tex_map_bone = {
	{(PropertyRNA *)&rna_VertexWeightMixModifier_invert_mask_vertex_group, (PropertyRNA *)&rna_VertexWeightMixModifier_mask_tex_map_object,
	-1, "mask_tex_map_bone", 262145, 0, 0, 0, 0, "Texture Coordinate Bone",
	"Which bone to take texture coordinates from",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	VertexWeightMixModifier_mask_tex_map_bone_get, VertexWeightMixModifier_mask_tex_map_bone_length, VertexWeightMixModifier_mask_tex_map_bone_set, NULL, NULL, NULL, 64, ""
};

BoolPropertyRNA rna_VertexWeightMixModifier_invert_mask_vertex_group = {
	{NULL, (PropertyRNA *)&rna_VertexWeightMixModifier_mask_tex_map_bone,
	-1, "invert_mask_vertex_group", 3, 0, 0, 0, 0, "Invert",
	"Invert vertex group mask influence",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StructRNA RNA_VertexWeightMixModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_VertexWeightMixModifier_vertex_group_a, (PropertyRNA *)&rna_VertexWeightMixModifier_invert_mask_vertex_group}},
...
BoolPropertyRNA rna_VertexWeightProximityModifier_invert_falloff = {
	{(PropertyRNA *)&rna_VertexWeightProximityModifier_mask_constant, (PropertyRNA *)&rna_VertexWeightProximityModifier_falloff_type,
	-1, "invert_falloff", 3, 0, 0, 0, 0, "Invert Falloff",
	"Invert the resulting falloff weight",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_VertexWeightProximityModifier_mask_constant = {
	{(PropertyRNA *)&rna_VertexWeightProximityModifier_mask_vertex_group, (PropertyRNA *)&rna_VertexWeightProximityModifier_invert_falloff,
	-1, "mask_constant", 3, 0, 0, 4, 0, "Influence",
	"Global influence of current modifications on vgroup",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StringPropertyRNA rna_VertexWeightProximityModifier_mask_tex_map_bone = {
	{(PropertyRNA *)&rna_VertexWeightProximityModifier_invert_mask_vertex_group, (PropertyRNA *)&rna_VertexWeightProximityModifier_mask_tex_map_object,
	-1, "mask_tex_map_bone", 262145, 0, 0, 0, 0, "Texture Coordinate Bone",
	"Which bone to take texture coordinates from",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
	rna_Modifier_dependency_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	VertexWeightProximityModifier_mask_tex_map_bone_get, VertexWeightProximityModifier_mask_tex_map_bone_length, VertexWeightProximityModifier_mask_tex_map_bone_set, NULL, NULL, NULL, 64, ""
};

BoolPropertyRNA rna_VertexWeightProximityModifier_invert_mask_vertex_group = {
	{NULL, (PropertyRNA *)&rna_VertexWeightProximityModifier_mask_tex_map_bone,
	-1, "invert_mask_vertex_group", 3, 0, 0, 0, 0, "Invert",
	"Invert vertex group mask influence",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StructRNA RNA_VertexWeightProximityModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_VertexWeightProximityModifier_vertex_group, (PropertyRNA *)&rna_VertexWeightProximityModifier_invert_mask_vertex_group}},
...
EnumPropertyRNA rna_OceanModifier_spectrum = {
	...
	-1, "spectrum", 3, 0, 0, 0, 0, "Spectrum",
	"Spectrum to use",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_OceanModifier_init_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	OceanModifier_spectrum_get, OceanModifier_spectrum_set, NULL, NULL, NULL, NULL, rna_OceanModifier_spectrum_items, 4, 0
};

FloatPropertyRNA rna_OceanModifier_fetch_jonswap = {
	{(PropertyRNA *)&rna_OceanModifier_sharpen_peak_jonswap, (PropertyRNA *)&rna_OceanModifier_spectrum,
	-1, "fetch_jonswap", 3, 0, 0, 4, 0, "Fetch",
	...
	OceanModifier_fetch_jonswap_get, OceanModifier_fetch_jonswap_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_OceanModifier_sharpen_peak_jonswap = {
	{(PropertyRNA *)&rna_OceanModifier_random_seed, (PropertyRNA *)&rna_OceanModifier_fetch_jonswap,
	-1, "sharpen_peak_jonswap", 3, 0, 0, 4, 0, "Sharpen peak",
	"Peak sharpening for \'JONSWAP\' and \'TMA\' models",
	0, "*",
	PROP_FLOAT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_OceanModifier_init_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(OceanModifierData, sharpen_peak_jonswap), 5, NULL},
	OceanModifier_sharpen_peak_jonswap_get, OceanModifier_sharpen_peak_jonswap_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_RemeshModifier_mode = {
	...
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	RemeshModifier_mode_get, RemeshModifier_mode_set, NULL, NULL, NULL, NULL, rna_RemeshModifier_mode_items, 4, 0
};
...
FloatPropertyRNA rna_RemeshModifier_voxel_size = {
	...
	-1, "voxel_size", 3, 0, 0, 4, 0, "Voxel Size",
	...
	RemeshModifier_voxel_size_get, RemeshModifier_voxel_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0001000000f, 2.0f, -FLT_MAX, FLT_MAX, 0.1000000015f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_RemeshModifier_adaptivity = {
	{(PropertyRNA *)&rna_RemeshModifier_use_remove_disconnected, (PropertyRNA *)&rna_RemeshModifier_voxel_size,
	-1, "adaptivity", 3, 0, 0, 4, 0, "Adaptivity",
	...
	RemeshModifier_adaptivity_get, RemeshModifier_adaptivity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, -FLT_MAX, FLT_MAX, 0.1000000015f, 3, 0.0f, NULL
};
...
StringPropertyRNA rna_LaplacianDeformModifier_vertex_group = {
	...
	-1, "vertex_group", 262145, 0, 0, 0, 0, "Anchor Weights",
...
/* Weld Modifier */
FloatPropertyRNA rna_WeldModifier_merge_threshold = {
	{(PropertyRNA *)&rna_WeldModifier_max_interactions, NULL,
	-1, "merge_threshold", 3, 0, 0, 4, 0, "Merge Distance",
	"Limit below which to merge vertices",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	...
	WeldModifier_merge_threshold_get, WeldModifier_merge_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, FLT_MAX, 0.0010000000f, 6, 0.0f, NULL
};

IntPropertyRNA rna_WeldModifier_max_interactions = {
	{(PropertyRNA *)&rna_WeldModifier_vertex_group, (PropertyRNA *)&rna_WeldModifier_merge_threshold,
	-1, "max_interactions", 3, 0, 0, 4, 0, "Duplicate Limit",
	"For a better performance, limits the number of elements found per vertex. (0 makes it infinite)",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(WeldModifierData, max_interactions), 0, NULL},
	WeldModifier_max_interactions_get, WeldModifier_max_interactions_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 10000, 0, INT_MAX, 1, 0, NULL
};

StringPropertyRNA rna_WeldModifier_vertex_group = {
	{(PropertyRNA *)&rna_WeldModifier_invert_vertex_group, (PropertyRNA *)&rna_WeldModifier_max_interactions,
	-1, "vertex_group", 262145, 0, 0, 0, 0, "Vertex Group",
	...
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WeldModifier_vertex_group_get, WeldModifier_vertex_group_length, WeldModifier_vertex_group_set, NULL, NULL, NULL, 64, ""
};

BoolPropertyRNA rna_WeldModifier_invert_vertex_group = {
	{NULL, (PropertyRNA *)&rna_WeldModifier_vertex_group,
	-1, "invert_vertex_group", 3, 0, 0, 0, 0, "Invert",
	"Invert vertex group influence",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StructRNA RNA_WeldModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_WeldModifier_merge_threshold, (PropertyRNA *)&rna_WeldModifier_invert_vertex_group}},
...
StringPropertyRNA rna_SurfaceDeformModifier_vertex_group = {
	...
	rna_Modifier_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SurfaceDeformModifier_vertex_group_get, SurfaceDeformModifier_vertex_group_length, SurfaceDeformModifier_vertex_group_set, NULL, NULL, NULL, 64, ""
};

BoolPropertyRNA rna_SurfaceDeformModifier_invert_vertex_group = {
	{(PropertyRNA *)&rna_SurfaceDeformModifier_strength, (PropertyRNA *)&rna_SurfaceDeformModifier_vertex_group,
	-1, "invert_vertex_group", 3, 0, 0, 0, 0, "Invert",
	"Invert vertex group influence",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_SurfaceDeformModifier_strength = {
	{NULL, (PropertyRNA *)&rna_SurfaceDeformModifier_invert_vertex_group,
	-1, "strength", 3, 0, 0, 4, 0, "Strength",
	...
	SurfaceDeformModifier_strength_get, SurfaceDeformModifier_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -100.0f, 100.0f, -100.0f, 100.0f, 10.0f, 2, 0.0f, NULL
};
