...
EnumPropertyRNA rna_FluidDomainSettings_noise_type;
...
CollectionPropertyRNA rna_FluidDomainSettings_mesh_vertices;
...
EnumPropertyRNA rna_FluidDomainSettings_slice_method;
EnumPropertyRNA rna_FluidDomainSettings_axis_slice_method;
...
EnumPropertyRNA rna_FluidDomainSettings_coba_field;
PointerPropertyRNA rna_FluidDomainSettings_color_ramp;
FloatPropertyRNA rna_FluidDomainSettings_clipping;
PointerPropertyRNA rna_FluidDomainSettings_point_cache;
EnumPropertyRNA rna_FluidDomainSettings_point_cache_compress_type;
EnumPropertyRNA rna_FluidDomainSettings_openvdb_cache_compress_type;
EnumPropertyRNA rna_FluidDomainSettings_data_depth;


CollectionPropertyRNA rna_FluidDomainVertexVelocity_rna_properties;
PointerPropertyRNA rna_FluidDomainVertexVelocity_rna_type;
FloatPropertyRNA rna_FluidDomainVertexVelocity_velocity;
...
int FluidDomainSettings_noise_type_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return (int)(data->noise_type);
}

void FluidDomainSettings_noise_type_set(PointerRNA *ptr, int value)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    data->noise_type = value;
}
...
int FluidDomainSettings_mesh_vertices_length(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return (data->mesh_velocities == NULL) ? 0 : data->totvert;
}

static PointerRNA FluidDomainSettings_mesh_vertices_get(CollectionPropertyIterator *iter)
{
    return rna_pointer_inherit_refine(&iter->parent, &RNA_FluidDomainVertexVelocity, rna_iterator_array_get(iter));
}

void FluidDomainSettings_mesh_vertices_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);

    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_FluidDomainSettings_mesh_vertices;

    rna_iterator_array_begin(iter, data->mesh_velocities, sizeof(data->mesh_velocities[0]), data->totvert, 0, NULL);

    if (iter->valid)
        iter->ptr = FluidDomainSettings_mesh_vertices_get(iter);
}

void FluidDomainSettings_mesh_vertices_next(CollectionPropertyIterator *iter)
{
...
void FluidDomainSettings_mesh_vertices_end(CollectionPropertyIterator *iter)
{
    rna_iterator_array_end(iter);
}

int FluidDomainSettings_mesh_vertices_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
    int found = 0;
    CollectionPropertyIterator iter;

    FluidDomainSettings_mesh_vertices_begin(&iter, ptr);
    ...
    if (iter.valid) {
        ...
        if (found) *r_ptr = FluidDomainSettings_mesh_vertices_get(&iter);
    }

    FluidDomainSettings_mesh_vertices_end(&iter);
...
int FluidDomainSettings_slice_method_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return (int)(data->slice_method);
}

void FluidDomainSettings_slice_method_set(PointerRNA *ptr, int value)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    data->slice_method = value;
}

int FluidDomainSettings_axis_slice_method_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return (int)(data->axis_slice_method);
}

void FluidDomainSettings_axis_slice_method_set(PointerRNA *ptr, int value)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
...
int FluidDomainSettings_coba_field_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return (int)(data->coba_field);
}

void FluidDomainSettings_coba_field_set(PointerRNA *ptr, int value)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
...
PointerRNA FluidDomainSettings_point_cache_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return rna_pointer_inherit_refine(ptr, &RNA_PointCache, data->point_cache[0]);
}

int FluidDomainSettings_point_cache_compress_type_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return (int)(data->cache_comp);
}

void FluidDomainSettings_point_cache_compress_type_set(PointerRNA *ptr, int value)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
...
int FluidDomainSettings_data_depth_get(PointerRNA *ptr)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    return ((data->data_depth) & 16);
}

void FluidDomainSettings_data_depth_set(PointerRNA *ptr, int value)
{
    FluidDomainSettings *data = (FluidDomainSettings *)(ptr->data);
    data->data_depth &= ~16;
...
static PointerRNA FluidDomainVertexVelocity_rna_properties_get(CollectionPropertyIterator *iter)
{
    return rna_builtin_properties_get(iter);
}

void FluidDomainVertexVelocity_rna_properties_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{

    memset(iter, 0, sizeof(*iter));
    iter->parent = *ptr;
    iter->prop = (PropertyRNA *)&rna_FluidDomainVertexVelocity_rna_properties;

    rna_builtin_properties_begin(iter, ptr);

    if (iter->valid)
        iter->ptr = FluidDomainVertexVelocity_rna_properties_get(iter);
}

void FluidDomainVertexVelocity_rna_properties_next(CollectionPropertyIterator *iter)
{
    rna_builtin_properties_next(iter);
...
void FluidDomainVertexVelocity_rna_properties_end(CollectionPropertyIterator *iter)
{
    rna_iterator_listbase_end(iter);
}

int FluidDomainVertexVelocity_rna_properties_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
    return rna_builtin_properties_lookup_string(ptr, key, r_ptr);
}

PointerRNA FluidDomainVertexVelocity_rna_type_get(PointerRNA *ptr)
{
    return rna_builtin_type_get(ptr);
}

void FluidDomainVertexVelocity_velocity_get(PointerRNA *ptr, float values[3])
{
    FluidDomainVertexVelocity *data = (FluidDomainVertexVelocity *)(ptr->data);
    unsigned int i;
...
PointerPropertyRNA rna_FluidDomainSettings_effector_group = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_reset_dependency, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FloatPropertyRNA rna_FluidDomainSettings_density_grid = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FluidDomainSettings_density_grid_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_density_grid_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_velocity_grid = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FluidDomainSettings_velocity_grid_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_velocity_grid_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_flame_grid = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FluidDomainSettings_flame_grid_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_flame_grid_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_color_grid = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FluidDomainSettings_color_grid_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_color_grid_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_heat_grid = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FluidDomainSettings_heat_grid_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_heat_grid_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_temperature_grid = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, FluidDomainSettings_temperature_grid_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_temperature_grid_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_start_point = {
	...
	NULL, NULL, FluidDomainSettings_start_point_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_start_point_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_cell_size = {
	...
	NULL, NULL, FluidDomainSettings_cell_size_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_cell_size_default
};
...
IntPropertyRNA rna_FluidDomainSettings_domain_resolution = {
	...
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, rna_FluidDomainSettings_domain_resolution_default
};
...
IntPropertyRNA rna_FluidDomainSettings_additional_res = {
	...
	rna_Fluid_datacache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
FloatPropertyRNA rna_FluidDomainSettings_adapt_threshold = {
	...
	FluidDomainSettings_adapt_threshold_get, FluidDomainSettings_adapt_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 0.0199999996f, 6, 0.0f, NULL
};
...
BoolPropertyRNA rna_FluidDomainSettings_use_adaptive_domain = {
	...
	rna_Fluid_domain_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FloatPropertyRNA rna_FluidDomainSettings_gravity = {
	...
	NULL, NULL, FluidDomainSettings_gravity_get, FluidDomainSettings_gravity_set, NULL, NULL, NULL, NULL, NULL, NULL, -1000.0999755859f, 1000.0999755859f, -1000.0999755859f, 1000.0999755859f, 10.0f, 3, 0.0f, rna_FluidDomainSettings_gravity_default
};
...
EnumPropertyRNA rna_FluidDomainSettings_domain_type = {
	...
	rna_Fluid_flip_parts_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_domain_type_get, FluidDomainSettings_domain_type_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_domain_type_items, 2, 0
};
...
FloatPropertyRNA rna_FluidDomainSettings_alpha = {
	...
	FluidDomainSettings_alpha_get, FluidDomainSettings_alpha_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -5.0f, 5.0f, 0.0199999996f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_beta = {
	...
	FluidDomainSettings_beta_get, FluidDomainSettings_beta_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -5.0f, 5.0f, 0.0199999996f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_vorticity = {
	...
	FluidDomainSettings_vorticity_get, FluidDomainSettings_vorticity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 4.0f, 0.0f, 4.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_FluidDomainSettings_highres_sampling = {
	...
	rna_Fluid_datacache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_highres_sampling_get, FluidDomainSettings_highres_sampling_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_highres_sampling_items, 3, 0
};
...
BoolPropertyRNA rna_FluidDomainSettings_use_dissolve_smoke_log = {
	...
	rna_Fluid_datacache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_use_dissolve_smoke_log_get, FluidDomainSettings_use_dissolve_smoke_log_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_burning_rate = {
	...
	FluidDomainSettings_burning_rate_get, FluidDomainSettings_burning_rate_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 2.0f, 0.0099999998f, 4.0f, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_flame_smoke = {
	...
	FluidDomainSettings_flame_smoke_get, FluidDomainSettings_flame_smoke_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 4.0f, 0.0f, 8.0f, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_flame_vorticity = {
	...
	FluidDomainSettings_flame_vorticity_get, FluidDomainSettings_flame_vorticity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 2.0f, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_flame_ignition = {
	...
	FluidDomainSettings_flame_ignition_get, FluidDomainSettings_flame_ignition_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5000000000f, 2.5000000000f, 0.5000000000f, 5.0f, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_flame_max_temp = {
	...
	FluidDomainSettings_flame_max_temp_get, FluidDomainSettings_flame_max_temp_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1.0f, 5.0f, 1.0f, 10.0f, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_flame_smoke_color = {
	...
	NULL, NULL, FluidDomainSettings_flame_smoke_color_get, FluidDomainSettings_flame_smoke_color_set, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainSettings_flame_smoke_color_default
};
...
FloatPropertyRNA rna_FluidDomainSettings_noise_strength = {
	...
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_noisecache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(FluidDomainSettings, noise_strength), 5, NULL},
	FluidDomainSettings_noise_strength_get, FluidDomainSettings_noise_strength_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 1.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_noise_pos_scale = {
	...
	FluidDomainSettings_noise_pos_scale_get, FluidDomainSettings_noise_pos_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0001000000f, 10.0f, 0.0001000000f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_noise_time_anim = {
	...
	FluidDomainSettings_noise_time_anim_get, FluidDomainSettings_noise_time_anim_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0001000000f, 10.0f, 0.0001000000f, 10.0f, 10.0f, 3, 0.0f, NULL
};

IntPropertyRNA rna_FluidDomainSettings_noise_scale = {
	{(PropertyRNA *)&rna_FluidDomainSettings_noise_type, (PropertyRNA *)&rna_FluidDomainSettings_noise_time_anim,
...
static const EnumPropertyItem rna_FluidDomainSettings_noise_type_items[2] = {
	{1, "NOISEWAVE", 0, "Wavelet", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_FluidDomainSettings_noise_type = {
	{(PropertyRNA *)&rna_FluidDomainSettings_use_noise, (PropertyRNA *)&rna_FluidDomainSettings_noise_scale,
	...
	rna_Fluid_domain_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_noise_type_get, FluidDomainSettings_noise_type_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_noise_type_items, 1, 1
};

BoolPropertyRNA rna_FluidDomainSettings_use_noise = {
	{(PropertyRNA *)&rna_FluidDomainSettings_simulation_method, (PropertyRNA *)&rna_FluidDomainSettings_noise_type,
	-1, "use_noise", 1, 0, 0, 0, 0, "Use Noise",
	"Enable fluid noise (using amplification)",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_update, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_use_noise_get, FluidDomainSettings_use_noise_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_FluidDomainSettings_simulation_method_items[2] = {
	{1, "FLIP", 0, "FLIP", "Use FLIP as the simulation method"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_FluidDomainSettings_simulation_method = {
	{(PropertyRNA *)&rna_FluidDomainSettings_flip_ratio, (PropertyRNA *)&rna_FluidDomainSettings_use_noise,
	-1, "simulation_method", 3, 0, 0, 0, 0, "Simulation Method",
	"Change the underlying simulation method",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_domain_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_simulation_method_get, FluidDomainSettings_simulation_method_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_simulation_method_items, 1, 1
};
...
FloatPropertyRNA rna_FluidDomainSettings_flip_ratio = {
	...
	FluidDomainSettings_flip_ratio_get, FluidDomainSettings_flip_ratio_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_particle_randomness = {
	...
	FluidDomainSettings_particle_randomness_get, FluidDomainSettings_particle_randomness_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_particle_radius = {
	...
	FluidDomainSettings_particle_radius_get, FluidDomainSettings_particle_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_particle_band_width = {
	...
	FluidDomainSettings_particle_band_width_get, FluidDomainSettings_particle_band_width_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_fractions_threshold = {
	{(PropertyRNA *)&rna_FluidDomainSettings_use_diffusion, (PropertyRNA *)&rna_FluidDomainSettings_use_fractions,
	-1, "fractions_threshold", 3, 0, 0, 4, 0, "Obstacle-Fluid Threshold ",
	...
	FluidDomainSettings_fractions_threshold_get, FluidDomainSettings_fractions_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 1.0f, 0.0010000000f, 1.0f, 0.0500000007f, -1, 0.0f, NULL
};

BoolPropertyRNA rna_FluidDomainSettings_use_diffusion = {
	{(PropertyRNA *)&rna_FluidDomainSettings_surface_tension, (PropertyRNA *)&rna_FluidDomainSettings_fractions_threshold,
...
FloatPropertyRNA rna_FluidDomainSettings_surface_tension = {
	...
	FluidDomainSettings_surface_tension_get, FluidDomainSettings_surface_tension_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_viscosity_base = {
	...
	FluidDomainSettings_viscosity_base_get, FluidDomainSettings_viscosity_base_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_mesh_concave_upper = {
	...
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_meshcache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(FluidDomainSettings, mesh_concave_upper), 5, NULL},
	FluidDomainSettings_mesh_concave_upper_get, FluidDomainSettings_mesh_concave_upper_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_mesh_concave_lower = {
	...
	FluidDomainSettings_mesh_concave_lower_get, FluidDomainSettings_mesh_concave_lower_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_FluidDomainSettings_mesh_generator = {
	{(PropertyRNA *)&rna_FluidDomainSettings_mesh_vertices, (PropertyRNA *)&rna_FluidDomainSettings_mesh_scale,
	-1, "mesh_generator", 3, 0, 0, 0, 0, "Mesh generator",
	"Which particle level set generator to use",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_mesh_generator_get, FluidDomainSettings_mesh_generator_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_mesh_generator_items, 2, 0
};

CollectionPropertyRNA rna_FluidDomainSettings_mesh_vertices = {
	{(PropertyRNA *)&rna_FluidDomainSettings_use_mesh, (PropertyRNA *)&rna_FluidDomainSettings_mesh_generator,
	-1, "mesh_vertices", 0, 0, 0, 8, 0, "Fluid Mesh Vertices",
	"Vertices of the fluid mesh generated by simulation",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_mesh_vertices_begin, FluidDomainSettings_mesh_vertices_next, FluidDomainSettings_mesh_vertices_end, FluidDomainSettings_mesh_vertices_get, FluidDomainSettings_mesh_vertices_length, FluidDomainSettings_mesh_vertices_lookup_int, NULL, NULL, &RNA_FluidDomainVertexVelocity
};

BoolPropertyRNA rna_FluidDomainSettings_use_mesh = {
	{(PropertyRNA *)&rna_FluidDomainSettings_use_speed_vectors, (PropertyRNA *)&rna_FluidDomainSettings_mesh_vertices,
...
FloatPropertyRNA rna_FluidDomainSettings_mesh_particle_radius = {
	...
	FluidDomainSettings_mesh_particle_radius_get, FluidDomainSettings_mesh_particle_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_potential_min_wavecrest = {
	...
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_particlescache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(FluidDomainSettings, sndparticle_tau_min_wc), 5, NULL},
	FluidDomainSettings_sndparticle_potential_min_wavecrest_get, FluidDomainSettings_sndparticle_potential_min_wavecrest_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 100.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_potential_max_wavecrest = {
	...
	FluidDomainSettings_sndparticle_potential_max_wavecrest_get, FluidDomainSettings_sndparticle_potential_max_wavecrest_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 100.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_potential_min_trappedair = {
	...
	FluidDomainSettings_sndparticle_potential_min_trappedair_get, FluidDomainSettings_sndparticle_potential_min_trappedair_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 1000.0f, 100.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_potential_max_trappedair = {
	...
	FluidDomainSettings_sndparticle_potential_max_trappedair_get, FluidDomainSettings_sndparticle_potential_max_trappedair_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 100.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_potential_min_energy = {
	...
	FluidDomainSettings_sndparticle_potential_min_energy_get, FluidDomainSettings_sndparticle_potential_min_energy_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 100.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_potential_max_energy = {
	...
	FluidDomainSettings_sndparticle_potential_max_energy_get, FluidDomainSettings_sndparticle_potential_max_energy_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 100.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_bubble_buoyancy = {
	...
	FluidDomainSettings_sndparticle_bubble_buoyancy_get, FluidDomainSettings_sndparticle_bubble_buoyancy_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_bubble_drag = {
	...
	FluidDomainSettings_sndparticle_bubble_drag_get, FluidDomainSettings_sndparticle_bubble_drag_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_life_min = {
	...
	FluidDomainSettings_sndparticle_life_min_get, FluidDomainSettings_sndparticle_life_min_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 10000.0f, 100.0f, 1, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_sndparticle_life_max = {
	...
	FluidDomainSettings_sndparticle_life_max_get, FluidDomainSettings_sndparticle_life_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 10000.0f, 100.0f, 1, 0.0f, NULL
};
...
EnumPropertyRNA rna_FluidDomainSettings_sndparticle_boundary = {
	...
	-1, "sndparticle_boundary", 3, 0, 0, 0, 0, "Particles in Boundary",
	"How particles that left the domain are treated",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_particlescache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_sndparticle_boundary_get, FluidDomainSettings_sndparticle_boundary_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_sndparticle_boundary_items, 2, 0
};
...
EnumPropertyRNA rna_FluidDomainSettings_sndparticle_combined_export = {
	...
	-1, "sndparticle_combined_export", 3, 0, 0, 0, 0, "Combined Export",
	...
	0, -1, NULL},
	FluidDomainSettings_sndparticle_combined_export_get, FluidDomainSettings_sndparticle_combined_export_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_sndparticle_combined_export_items, 5, 0
};
...
BoolPropertyRNA rna_FluidDomainSettings_use_spray_particles = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_spray_parts_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
BoolPropertyRNA rna_FluidDomainSettings_use_bubble_particles = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_bubble_parts_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
BoolPropertyRNA rna_FluidDomainSettings_use_foam_particles = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_foam_parts_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
BoolPropertyRNA rna_FluidDomainSettings_use_tracer_particles = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_tracer_parts_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FloatPropertyRNA rna_FluidDomainSettings_guide_alpha = {
	...
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_guidingcache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(FluidDomainSettings, guide_alpha), 5, NULL},
	FluidDomainSettings_guide_alpha_get, FluidDomainSettings_guide_alpha_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1.0f, 100.0f, 1.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_guide_vel_factor = {
	...
	FluidDomainSettings_guide_vel_factor_get, FluidDomainSettings_guide_vel_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_FluidDomainSettings_guide_source = {
	...
	-1, "guide_source", 3, 0, 0, 0, 0, "Guiding source",
	"Choose where to get guiding velocities from",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_update, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_guide_source_get, FluidDomainSettings_guide_source_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_guide_source_items, 2, 0
};
...
PointerPropertyRNA rna_FluidDomainSettings_guide_parent = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_guidingcache_reset, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
IntPropertyRNA rna_FluidDomainSettings_cache_frame_start = {
	...
	-1, "cache_frame_start", 3, 0, 0, 0, 0, "Start",
...
IntPropertyRNA rna_FluidDomainSettings_cache_frame_end = {
	{(PropertyRNA *)&rna_FluidDomainSettings_cache_frame_pause_data, (PropertyRNA *)&rna_FluidDomainSettings_cache_frame_start,
	-1, "cache_frame_end", 3, 0, 0, 0, 0, "End",
...
IntPropertyRNA rna_FluidDomainSettings_cache_frame_pause_data = {
	{(PropertyRNA *)&rna_FluidDomainSettings_cache_frame_pause_noise, (PropertyRNA *)&rna_FluidDomainSettings_cache_frame_end,
...
EnumPropertyRNA rna_FluidDomainSettings_cache_mesh_format = {
	...
	-1, "cache_mesh_format", 3, 0, 0, 0, 0, "File Format",
	"Select the file format to be used for caching surface data",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_meshcache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_cache_mesh_format_get, FluidDomainSettings_cache_mesh_format_set, rna_Fluid_cachetype_mesh_itemf, NULL, NULL, NULL, rna_FluidDomainSettings_cache_mesh_format_items, 1, 0
};
...
EnumPropertyRNA rna_FluidDomainSettings_cache_data_format = {
	...
	-1, "cache_data_format", 3, 0, 0, 0, 0, "File Format",
	"Select the file format to be used for caching volumetric data",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_datacache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_cache_data_format_get, FluidDomainSettings_cache_data_format_set, rna_Fluid_cachetype_volume_itemf, NULL, NULL, NULL, rna_FluidDomainSettings_cache_data_format_items, 1, 0
};
...
EnumPropertyRNA rna_FluidDomainSettings_cache_particle_format = {
	...
	-1, "cache_particle_format", 3, 0, 0, 0, 0, "File Format",
	"Select the file format to be used for caching particle data",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_particlescache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_cache_particle_format_get, FluidDomainSettings_cache_particle_format_set, rna_Fluid_cachetype_particle_itemf, NULL, NULL, NULL, rna_FluidDomainSettings_cache_particle_format_items, 1, 0
};
...
EnumPropertyRNA rna_FluidDomainSettings_cache_noise_format = {
	...
	-1, "cache_noise_format", 3, 0, 0, 0, 0, "File Format",
	"Select the file format to be used for caching noise data",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_noisecache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_cache_noise_format_get, FluidDomainSettings_cache_noise_format_set, rna_Fluid_cachetype_volume_itemf, NULL, NULL, NULL, rna_FluidDomainSettings_cache_noise_format_items, 1, 0
};

static const EnumPropertyItem rna_FluidDomainSettings_cache_type_items[4] = {
	{0, "REPLAY", 0, "Replay", "Use the timeline to bake the scene. Pausing and resuming possible"},
	{1, "MODULAR", 0, "Modular", "Bake every stage of the simulation separately. Pausing and resuming possible"},
	{2, "FINAL", 0, "Final", "Bake the entire simulation at once. Only generates the most essential cache files. Pausing and resuming not possible"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_FluidDomainSettings_cache_type = {
	{(PropertyRNA *)&rna_FluidDomainSettings_cache_directory, (PropertyRNA *)&rna_FluidDomainSettings_cache_noise_format,
	-1, "cache_type", 3, 0, 0, 0, 0, "Type",
	"Change the cache type of the simulation",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_domain_reset, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_cache_type_get, FluidDomainSettings_cache_type_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_cache_type_items, 3, 0
};

StringPropertyRNA rna_FluidDomainSettings_cache_directory = {
	{(PropertyRNA *)&rna_FluidDomainSettings_is_cache_baking_data, (PropertyRNA *)&rna_FluidDomainSettings_cache_type,
	...
	rna_Fluid_update, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_cache_directory_get, FluidDomainSettings_cache_directory_length, FluidDomainSettings_cache_directory_set, NULL, NULL, NULL, 1024, ""
};
...
BoolPropertyRNA rna_FluidDomainSettings_export_manta_script = {
	{(PropertyRNA *)&rna_FluidDomainSettings_time_scale, (PropertyRNA *)&rna_FluidDomainSettings_has_cache_baked_any,
...
FloatPropertyRNA rna_FluidDomainSettings_time_scale = {
	{(PropertyRNA *)&rna_FluidDomainSettings_cfl_condition, (PropertyRNA *)&rna_FluidDomainSettings_export_manta_script,
	...
	FluidDomainSettings_time_scale_get, FluidDomainSettings_time_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0001000000f, 10.0f, 0.0001000000f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_cfl_condition = {
	...
	FluidDomainSettings_cfl_condition_get, FluidDomainSettings_cfl_condition_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 10.0f, 3, 0.0f, NULL
};
...
BoolPropertyRNA rna_FluidDomainSettings_use_adaptive_timesteps = {
	...
	rna_Fluid_datacache_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_use_adaptive_timesteps_get, FluidDomainSettings_use_adaptive_timesteps_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
IntPropertyRNA rna_FluidDomainSettings_timesteps_min = {
	...
	0, 100, 1, 100, 1, 0, NULL
};

IntPropertyRNA rna_FluidDomainSettings_timesteps_max = {
	{(PropertyRNA *)&rna_FluidDomainSettings_slice_method, (PropertyRNA *)&rna_FluidDomainSettings_timesteps_min,
...
static const EnumPropertyItem rna_FluidDomainSettings_slice_method_items[3] = {
...
EnumPropertyRNA rna_FluidDomainSettings_slice_method = {
	{(PropertyRNA *)&rna_FluidDomainSettings_axis_slice_method, (PropertyRNA *)&rna_FluidDomainSettings_timesteps_max,
	...
	0, -1, NULL},
	FluidDomainSettings_slice_method_get, FluidDomainSettings_slice_method_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_slice_method_items, 2, 0
};

static const EnumPropertyItem rna_FluidDomainSettings_axis_slice_method_items[3] = {
...
EnumPropertyRNA rna_FluidDomainSettings_axis_slice_method = {
	{(PropertyRNA *)&rna_FluidDomainSettings_slice_axis, (PropertyRNA *)&rna_FluidDomainSettings_slice_method,
	...
	NULL, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_axis_slice_method_get, FluidDomainSettings_axis_slice_method_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_axis_slice_method_items, 2, 0
};
...
EnumPropertyRNA rna_FluidDomainSettings_slice_axis = {
	{(PropertyRNA *)&rna_FluidDomainSettings_slice_per_voxel, (PropertyRNA *)&rna_FluidDomainSettings_axis_slice_method,
	...
	NULL, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_slice_axis_get, FluidDomainSettings_slice_axis_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_slice_axis_items, 4, 0
};
...
FloatPropertyRNA rna_FluidDomainSettings_slice_per_voxel = {
	...
	FluidDomainSettings_slice_per_voxel_get, FluidDomainSettings_slice_per_voxel_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 5.0f, 0.0f, 100.0f, 0.1000000015f, 1, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_slice_depth = {
	...
	FluidDomainSettings_slice_depth_get, FluidDomainSettings_slice_depth_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 0.1000000015f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidDomainSettings_display_thickness = {
	...
	FluidDomainSettings_display_thickness_get, FluidDomainSettings_display_thickness_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 100.0f, 0.0010000000f, 1000.0f, 0.1000000015f, 3, 0.0f, NULL
};

static const EnumPropertyItem rna_FluidDomainSettings_display_interpolation_items[3] = {
...
EnumPropertyRNA rna_FluidDomainSettings_display_interpolation = {
	{(PropertyRNA *)&rna_FluidDomainSettings_show_velocity, (PropertyRNA *)&rna_FluidDomainSettings_display_thickness,
	...
	NULL, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_display_interpolation_get, FluidDomainSettings_display_interpolation_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_display_interpolation_items, 2, 0
};

BoolPropertyRNA rna_FluidDomainSettings_show_velocity = {
	{(PropertyRNA *)&rna_FluidDomainSettings_vector_display_type, (PropertyRNA *)&rna_FluidDomainSettings_display_interpolation,
...
static const EnumPropertyItem rna_FluidDomainSettings_vector_display_type_items[3] = {
...
EnumPropertyRNA rna_FluidDomainSettings_vector_display_type = {
	{(PropertyRNA *)&rna_FluidDomainSettings_vector_scale, (PropertyRNA *)&rna_FluidDomainSettings_show_velocity,
	...
	NULL, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_vector_display_type_get, FluidDomainSettings_vector_display_type_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_vector_display_type_items, 2, 0
};

FloatPropertyRNA rna_FluidDomainSettings_vector_scale = {
	{(PropertyRNA *)&rna_FluidDomainSettings_use_color_ramp, (PropertyRNA *)&rna_FluidDomainSettings_vector_display_type,
	...
	FluidDomainSettings_vector_scale_get, FluidDomainSettings_vector_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 1000.0f, 0.1000000015f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_FluidDomainSettings_use_color_ramp = {
	{(PropertyRNA *)&rna_FluidDomainSettings_coba_field, (PropertyRNA *)&rna_FluidDomainSettings_vector_scale,
...
static const EnumPropertyItem rna_FluidDomainSettings_coba_field_items[11] = {
...
EnumPropertyRNA rna_FluidDomainSettings_coba_field = {
	{(PropertyRNA *)&rna_FluidDomainSettings_color_ramp, (PropertyRNA *)&rna_FluidDomainSettings_use_color_ramp,
	...
	NULL, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_coba_field_get, FluidDomainSettings_coba_field_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_coba_field_items, 10, 0
};

PointerPropertyRNA rna_FluidDomainSettings_color_ramp = {
	{(PropertyRNA *)&rna_FluidDomainSettings_clipping, (PropertyRNA *)&rna_FluidDomainSettings_coba_field,
...
FloatPropertyRNA rna_FluidDomainSettings_clipping = {
	{(PropertyRNA *)&rna_FluidDomainSettings_point_cache, (PropertyRNA *)&rna_FluidDomainSettings_color_ramp,
	...
	FluidDomainSettings_clipping_get, FluidDomainSettings_clipping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 0.1000000015f, 6, 0.0f, NULL
};

PointerPropertyRNA rna_FluidDomainSettings_point_cache = {
	{(PropertyRNA *)&rna_FluidDomainSettings_point_cache_compress_type, (PropertyRNA *)&rna_FluidDomainSettings_clipping,
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_point_cache_get, NULL, NULL, NULL,&RNA_PointCache
};

static const EnumPropertyItem rna_FluidDomainSettings_point_cache_compress_type_items[3] = {
	{0, "CACHELIGHT", 0, "Lite", "Fast but not so effective compression"},
	{1, "CACHEHEAVY", 0, "Heavy", "Effective but slow compression"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_FluidDomainSettings_point_cache_compress_type = {
	{(PropertyRNA *)&rna_FluidDomainSettings_openvdb_cache_compress_type, (PropertyRNA *)&rna_FluidDomainSettings_point_cache,
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_point_cache_compress_type_get, FluidDomainSettings_point_cache_compress_type_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_point_cache_compress_type_items, 2, 0
};
...
EnumPropertyRNA rna_FluidDomainSettings_openvdb_cache_compress_type = {
	{(PropertyRNA *)&rna_FluidDomainSettings_data_depth, (PropertyRNA *)&rna_FluidDomainSettings_point_cache_compress_type,
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_openvdb_cache_compress_type_get, FluidDomainSettings_openvdb_cache_compress_type_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_openvdb_cache_compress_type_items, 2, 1
};

static const EnumPropertyItem rna_FluidDomainSettings_data_depth_items[3] = {
...
EnumPropertyRNA rna_FluidDomainSettings_data_depth = {
	{NULL, (PropertyRNA *)&rna_FluidDomainSettings_openvdb_cache_compress_type,
	...
	NULL, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainSettings_data_depth_get, FluidDomainSettings_data_depth_set, NULL, NULL, NULL, NULL, rna_FluidDomainSettings_data_depth_items, 2, 0
};

StructRNA RNA_FluidDomainSettings = {
	{(ContainerRNA *)&RNA_FluidDomainVertexVelocity, (ContainerRNA *)&RNA_BlendDataVolumes,
	NULL,
	{(PropertyRNA *)&rna_FluidDomainSettings_rna_properties, (PropertyRNA *)&rna_FluidDomainSettings_data_depth}},
...
/* Fluid Mesh Velocity */
CollectionPropertyRNA rna_FluidDomainVertexVelocity_rna_properties = {
	{(PropertyRNA *)&rna_FluidDomainVertexVelocity_rna_type, NULL,
	-1, "rna_properties", 0, 0, 0, 1, 0, "Properties",
	"RNA property collection",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainVertexVelocity_rna_properties_begin, FluidDomainVertexVelocity_rna_properties_next, FluidDomainVertexVelocity_rna_properties_end, FluidDomainVertexVelocity_rna_properties_get, NULL, NULL, FluidDomainVertexVelocity_rna_properties_lookup_string, NULL, &RNA_Property
};

PointerPropertyRNA rna_FluidDomainVertexVelocity_rna_type = {
	{(PropertyRNA *)&rna_FluidDomainVertexVelocity_velocity, (PropertyRNA *)&rna_FluidDomainVertexVelocity_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidDomainVertexVelocity_rna_type_get, NULL, NULL, NULL,&RNA_Struct
};

static float rna_FluidDomainVertexVelocity_velocity_default[3] = {
	0.0f,
	0.0f,
	0.0f
};
...
FloatPropertyRNA rna_FluidDomainVertexVelocity_velocity = {
	{NULL, (PropertyRNA *)&rna_FluidDomainVertexVelocity_rna_type,
	-1, "velocity", 2, 0, 0, 4, 0, "Velocity",
	"",
	0, "*",
	PROP_FLOAT, PROP_VELOCITY | PROP_UNIT_VELOCITY, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(FluidDomainVertexVelocity, vel), 5, NULL},
	NULL, NULL, FluidDomainVertexVelocity_velocity_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidDomainVertexVelocity_velocity_default
};

StructRNA RNA_FluidDomainVertexVelocity = {
	{(ContainerRNA *)&RNA_FluidFlowSettings, (ContainerRNA *)&RNA_FluidDomainSettings,
	NULL,
	{(PropertyRNA *)&rna_FluidDomainVertexVelocity_rna_properties, (PropertyRNA *)&rna_FluidDomainVertexVelocity_velocity}},
	"FluidDomainVertexVelocity", NULL, NULL, 516, NULL, "Fluid Mesh Velocity",
	"Velocity of a simulated fluid mesh",
	"*", 546,
	NULL, (PropertyRNA *)&rna_FluidDomainVertexVelocity_rna_properties,
	NULL,
	NULL,
	NULL,
	NULL,
...
FloatPropertyRNA rna_FluidFlowSettings_density = {
	...
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(FluidFlowSettings, density), 5, NULL},
	FluidFlowSettings_density_get, FluidFlowSettings_density_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 10.0f, 1.0f, 4, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_smoke_color = {
	...
	NULL, NULL, FluidFlowSettings_smoke_color_get, FluidFlowSettings_smoke_color_set, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, FLT_MAX, 10.0f, 3, 0.0f, rna_FluidFlowSettings_smoke_color_default
};
...
FloatPropertyRNA rna_FluidFlowSettings_fuel_amount = {
	...
	FluidFlowSettings_fuel_amount_get, FluidFlowSettings_fuel_amount_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 5.0f, 0.0f, 10.0f, 1.0f, 4, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_temperature = {
	...
	FluidFlowSettings_temperature_get, FluidFlowSettings_temperature_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10.0f, 10.0f, -10.0f, 10.0f, 1.0f, 1, 0.0f, NULL
};
...
EnumPropertyRNA rna_FluidFlowSettings_flow_type = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_flow_type_get, FluidFlowSettings_flow_type_set, NULL, NULL, NULL, NULL, rna_FluidFlowSettings_flow_type_items, 4, 1
};
...
EnumPropertyRNA rna_FluidFlowSettings_flow_behavior = {
	...
	-1, "flow_behavior", 3, 0, 0, 0, 0, "Flow Behavior",
	"Change flow behavior in the simulation",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_flow_behavior_get, FluidFlowSettings_flow_behavior_set, NULL, NULL, NULL, NULL, rna_FluidFlowSettings_flow_behavior_items, 3, 0
};
...
EnumPropertyRNA rna_FluidFlowSettings_flow_source = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_flow_source_get, FluidFlowSettings_flow_source_set, rna_Fluid_flowsource_itemf, NULL, NULL, NULL, rna_FluidFlowSettings_flow_source_items, 1, 0
};
...
BoolPropertyRNA rna_FluidFlowSettings_use_absolute = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_use_absolute_get, FluidFlowSettings_use_absolute_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_velocity_factor = {
	...
	FluidFlowSettings_velocity_factor_get, FluidFlowSettings_velocity_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -2.0f, 2.0f, -100.0f, 100.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_velocity_normal = {
	...
	FluidFlowSettings_velocity_normal_get, FluidFlowSettings_velocity_normal_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -2.0f, 2.0f, -100.0f, 100.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_velocity_random = {
	...
	FluidFlowSettings_velocity_random_get, FluidFlowSettings_velocity_random_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 2.0f, 0.0f, 10.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_velocity_coord = {
	...
	NULL, NULL, FluidFlowSettings_velocity_coord_get, FluidFlowSettings_velocity_coord_set, NULL, NULL, NULL, NULL, NULL, NULL, -1000.0999755859f, 1000.0999755859f, -1000.0999755859f, 1000.0999755859f, 10.0f, 3, 0.0f, rna_FluidFlowSettings_velocity_coord_default
};
...
FloatPropertyRNA rna_FluidFlowSettings_volume_density = {
	...
	FluidFlowSettings_volume_density_get, FluidFlowSettings_volume_density_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_surface_distance = {
	...
	FluidFlowSettings_surface_distance_get, FluidFlowSettings_surface_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_particle_size = {
	...
	FluidFlowSettings_particle_size_get, FluidFlowSettings_particle_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5000000000f, 5.0f, 0.1000000015f, 20.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
BoolPropertyRNA rna_FluidFlowSettings_use_particle_size = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_use_particle_size_get, FluidFlowSettings_use_particle_size_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
BoolPropertyRNA rna_FluidFlowSettings_use_inflow = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_use_inflow_get, FluidFlowSettings_use_inflow_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
StringPropertyRNA rna_FluidFlowSettings_density_vertex_group = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_density_vertex_group_get, FluidFlowSettings_density_vertex_group_length, FluidFlowSettings_density_vertex_group_set, NULL, NULL, NULL, 0, ""
};
...
EnumPropertyRNA rna_FluidFlowSettings_texture_map_type = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_texture_map_type_get, FluidFlowSettings_texture_map_type_set, NULL, NULL, NULL, NULL, rna_FluidFlowSettings_texture_map_type_items, 2, 0
};
...
StringPropertyRNA rna_FluidFlowSettings_uv_layer = {
	...
	rna_Fluid_flow_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidFlowSettings_uv_layer_get, FluidFlowSettings_uv_layer_length, FluidFlowSettings_uv_layer_set, NULL, NULL, NULL, 64, ""
};
...
FloatPropertyRNA rna_FluidFlowSettings_texture_size = {
	...
	FluidFlowSettings_texture_size_get, FluidFlowSettings_texture_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 5.0f, 0.0099999998f, 10.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidFlowSettings_texture_offset = {
	...
	FluidFlowSettings_texture_offset_get, FluidFlowSettings_texture_offset_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 100.0f, 0.0f, 200.0f, 0.0500000007f, 5, 0.0f, NULL
};

StructRNA RNA_FluidFlowSettings = {
	{(ContainerRNA *)&RNA_FluidEffectorSettings, (ContainerRNA *)&RNA_FluidDomainVertexVelocity,
	NULL,
...
EnumPropertyRNA rna_FluidEffectorSettings_effector_type = {
	...
	-1, "effector_type", 3, 0, 0, 0, 0, "Effector Type",
	"Change type of effector in the simulation",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_effector_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidEffectorSettings_effector_type_get, FluidEffectorSettings_effector_type_set, NULL, NULL, NULL, NULL, rna_FluidEffectorSettings_effector_type_items, 2, 0
};
...
FloatPropertyRNA rna_FluidEffectorSettings_surface_distance = {
	...
	FluidEffectorSettings_surface_distance_get, FluidEffectorSettings_surface_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 0.0500000007f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_FluidEffectorSettings_velocity_factor = {
	...
	FluidEffectorSettings_velocity_factor_get, FluidEffectorSettings_velocity_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -100.0f, 100.0f, -100.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_FluidEffectorSettings_guide_mode = {
	...
	-1, "guide_mode", 3, 0, 0, 0, 0, "Guiding mode",
	"How to create guiding velocities",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Fluid_effector_reset, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidEffectorSettings_guide_mode_get, FluidEffectorSettings_guide_mode_set, NULL, NULL, NULL, NULL, rna_FluidEffectorSettings_guide_mode_items, 4, 0
};
...
BoolPropertyRNA rna_FluidEffectorSettings_use_effector = {
	...
	rna_Fluid_effector_reset, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	FluidEffectorSettings_use_effector_get, FluidEffectorSettings_use_effector_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
