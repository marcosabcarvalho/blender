...
BoolPropertyRNA rna_ChildOfConstraint_set_inverse_pending = {
	...
	-1, "set_inverse_pending", 3, 0, 0, 0, 0, "Set Inverse Pending",
...
EnumPropertyRNA rna_StretchToConstraint_keep_axis = {
	...
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	StretchToConstraint_keep_axis_get, StretchToConstraint_keep_axis_set, NULL, NULL, NULL, NULL, rna_StretchToConstraint_keep_axis_items, 3, 0
};
...
static const EnumPropertyItem rna_ActionConstraint_mix_mode_items[4] = {
	{2, "BEFORE", 0, "Before Original", "Apply the action channels before the original transformation, as if applied to an imaginary parent with Aligned Inherit Scale"},
	{1, "AFTER", 0, "After Original", "Apply the action channels after the original transformation, as if applied to an imaginary child with Aligned Inherit Scale"},
	{0, "AFTER_FULL", 0, "After Original (Full Scale)", "Apply the action channels after the original transformation, as if applied to an imaginary child with Full Inherit Scale. This mode can create shear and is provided only for backward compatibility"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_ActionConstraint_mix_mode = {
	...
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	ActionConstraint_mix_mode_get, ActionConstraint_mix_mode_set, NULL, NULL, NULL, NULL, rna_ActionConstraint_mix_mode_items, 3, 0
};
...
FloatPropertyRNA rna_CopyScaleConstraint_power = {
	...
	CopyScaleConstraint_power_get, CopyScaleConstraint_power_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

BoolPropertyRNA rna_CopyScaleConstraint_use_make_uniform = {
	{(PropertyRNA *)&rna_CopyScaleConstraint_use_offset, (PropertyRNA *)&rna_CopyScaleConstraint_power,
	-1, "use_make_uniform", 3, 0, 0, 0, 0, "Make Uniform",
...
EnumPropertyRNA rna_MaintainVolumeConstraint_mode = {
	...
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	MaintainVolumeConstraint_mode_get, MaintainVolumeConstraint_mode_set, NULL, NULL, NULL, NULL, rna_MaintainVolumeConstraint_mode_items, 3, 0
};
...
EnumPropertyRNA rna_CopyRotationConstraint_euler_order = {
	...
	-1, "euler_order", 3, 0, 0, 0, 0, "Euler Order",
	"Explicitly specify the euler rotation order",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CopyRotationConstraint_euler_order_get, CopyRotationConstraint_euler_order_set, NULL, NULL, NULL, NULL, rna_CopyRotationConstraint_euler_order_items, 7, 0
};
...
EnumPropertyRNA rna_CopyRotationConstraint_mix_mode = {
	...
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CopyRotationConstraint_mix_mode_get, CopyRotationConstraint_mix_mode_set, NULL, NULL, NULL, NULL, rna_CopyRotationConstraint_mix_mode_items, 5, 0
};
...
StringPropertyRNA rna_CopyTransformsConstraint_subtarget = {
	{(PropertyRNA *)&rna_CopyTransformsConstraint_mix_mode, (PropertyRNA *)&rna_CopyTransformsConstraint_target,
	-1, "subtarget", 262145, 0, 0, 0, 0, "Sub-Target",
	"Armature bone, mesh or lattice vertex group, ...",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {64, 0, 0}, 0,
...
static const EnumPropertyItem rna_CopyTransformsConstraint_mix_mode_items[4] = {
	{0, "REPLACE", 0, "Replace", "Replace the original transformation with copied"},
	{1, "BEFORE", 0, "Before Original", "Apply copied transformation before original, as if the constraint target is a parent. Scale is handled specially to avoid creating shear"},
	{2, "AFTER", 0, "After Original", "Apply copied transformation after original, as if the constraint target is a child. Scale is handled specially to avoid creating shear"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_CopyTransformsConstraint_mix_mode = {
	...
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	CopyTransformsConstraint_mix_mode_get, CopyTransformsConstraint_mix_mode_set, NULL, NULL, NULL, NULL, rna_CopyTransformsConstraint_mix_mode_items, 3, 0
};
...
static const EnumPropertyItem rna_TransformConstraint_from_rotation_mode_items[12] = {
	{0, "AUTO", 0, "Auto Euler", "Euler using the rotation order of the target"},
	{1, "XYZ", 0, "XYZ Euler", "Euler using the XYZ rotation order"},
	{2, "XZY", 0, "XZY Euler", "Euler using the XZY rotation order"},
	{3, "YXZ", 0, "YXZ Euler", "Euler using the YXZ rotation order"},
	{4, "YZX", 0, "YZX Euler", "Euler using the YZX rotation order"},
	{5, "ZXY", 0, "ZXY Euler", "Euler using the ZXY rotation order"},
	{6, "ZYX", 0, "ZYX Euler", "Euler using the ZYX rotation order"},
	{7, "QUATERNION", 0, "Quaternion", "Quaternion rotation"},
	{8, "SWING_TWIST_X", 0, "Swing and X Twist", "Decompose into a swing rotation to aim the X axis, followed by twist around it"},
	{9, "SWING_TWIST_Y", 0, "Swing and Y Twist", "Decompose into a swing rotation to aim the Y axis, followed by twist around it"},
	{10, "SWING_TWIST_Z", 0, "Swing and Z Twist", "Decompose into a swing rotation to aim the Z axis, followed by twist around it"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_TransformConstraint_from_rotation_mode = {
	{(PropertyRNA *)&rna_TransformConstraint_to_euler_order, (PropertyRNA *)&rna_TransformConstraint_use_motion_extrapolate,
	-1, "from_rotation_mode", 3, 0, 0, 0, 0, "From Mode",
	"Specify the type of rotation channels to use",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	TransformConstraint_from_rotation_mode_get, TransformConstraint_from_rotation_mode_set, NULL, NULL, NULL, NULL, rna_TransformConstraint_from_rotation_mode_items, 11, 0
};
...
EnumPropertyRNA rna_TransformConstraint_to_euler_order = {
	...
	-1, "to_euler_order", 3, 0, 0, 0, 0, "To Order",
	"Explicitly specify the output euler rotation order",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	TransformConstraint_to_euler_order_get, TransformConstraint_to_euler_order_set, NULL, NULL, NULL, NULL, rna_TransformConstraint_to_euler_order_items, 7, 0
};
...
EnumPropertyRNA rna_TransformConstraint_mix_mode = {
	...
	-1, "mix_mode", 3, 0, 0, 0, 0, "Location Mix Mode",
	"Specify how to combine the new location with original",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	TransformConstraint_mix_mode_get, TransformConstraint_mix_mode_set, NULL, NULL, NULL, NULL, rna_TransformConstraint_mix_mode_items, 2, 0
};
...
EnumPropertyRNA rna_TransformConstraint_mix_mode_rot = {
	...
	-1, "mix_mode_rot", 3, 0, 0, 0, 0, "Rotation Mix Mode",
	"Specify how to combine the new rotation with original",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	TransformConstraint_mix_mode_rot_get, TransformConstraint_mix_mode_rot_set, NULL, NULL, NULL, NULL, rna_TransformConstraint_mix_mode_rot_items, 4, 0
};
...
EnumPropertyRNA rna_TransformConstraint_mix_mode_scale = {
	...
	-1, "mix_mode_scale", 3, 0, 0, 0, 0, "Scale Mix Mode",
	"Specify how to combine the new scale with original",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	TransformConstraint_mix_mode_scale_get, TransformConstraint_mix_mode_scale_set, NULL, NULL, NULL, NULL, rna_TransformConstraint_mix_mode_scale_items, 2, 0
};
...
EnumPropertyRNA rna_SplineIKConstraint_y_scale_mode = {
	...
	-1, "y_scale_mode", 3, 0, 0, 0, 0, "Y Scale Mode",
	"Method used for determining the scaling of the Y axis of the bones, on top of the shape and scaling of the curve itself",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SplineIKConstraint_y_scale_mode_get, SplineIKConstraint_y_scale_mode_set, NULL, NULL, NULL, NULL, rna_SplineIKConstraint_y_scale_mode_items, 3, 0
};

BoolPropertyRNA rna_SplineIKConstraint_use_original_scale = {
	{(PropertyRNA *)&rna_SplineIKConstraint_bulge, (PropertyRNA *)&rna_SplineIKConstraint_y_scale_mode,
	-1, "use_original_scale", 3, 0, 0, 0, 0, "Use Original Scale",
