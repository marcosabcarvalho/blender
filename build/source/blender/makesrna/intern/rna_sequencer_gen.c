...
FloatPropertyRNA rna_SequenceEditor_recycle_max_cost;
...
{
    rna_Sequence_frame_still_start_set(ptr, value);
}
...
{
    rna_Sequence_frame_still_end_set(ptr, value);
}
...
float SequenceEditor_recycle_max_cost_get(PointerRNA *ptr)
{
    Editing *data = (Editing *)(ptr->data);
    return (float)(data->recycle_max_cost);
}

void SequenceEditor_recycle_max_cost_set(PointerRNA *ptr, float value)
{
    Editing *data = (Editing *)(ptr->data);
    data->recycle_max_cost = CLAMPIS(value, 0.0f, 10.0f);
}
...
{
    Sequence *data = (Sequence *)(ptr->data);
    data->pan = CLAMPIS(value, -2.0f, 2.0f);
}
...
void Sequence_update_func(struct ID *_selfid, struct Sequence *_self, bool data)
{
...
struct StripElem *Sequence_strip_elem_from_frame_func(struct Sequence *_self, int frame)
{
...
void Sequence_swap_func(struct Sequence *_self, ReportList *reports, struct Sequence *other)
{
...
struct Sequence *Sequences_new_clip_func(struct ID *_selfid, struct Editing *_self, Main *bmain, const char * name, struct MovieClip *clip, int channel, int frame_start)
{
	return rna_Sequences_new_clip(_selfid, _self, bmain, name, clip, channel, frame_start);
}
...
void Sequences_new_clip_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	sequence = rna_Sequences_new_clip(_selfid, _self, CTX_data_main(C), name, clip, channel, frame_start);
	*((struct Sequence **)_retdata) = sequence;
}

struct Sequence *Sequences_new_mask_func(struct ID *_selfid, struct Editing *_self, Main *bmain, const char * name, struct Mask *mask, int channel, int frame_start)
{
	return rna_Sequences_new_mask(_selfid, _self, bmain, name, mask, channel, frame_start);
}
...
void Sequences_new_mask_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	sequence = rna_Sequences_new_mask(_selfid, _self, CTX_data_main(C), name, mask, channel, frame_start);
	*((struct Sequence **)_retdata) = sequence;
}

struct Sequence *Sequences_new_scene_func(struct ID *_selfid, struct Editing *_self, Main *bmain, const char * name, struct Scene *scene, int channel, int frame_start)
{
	return rna_Sequences_new_scene(_selfid, _self, bmain, name, scene, channel, frame_start);
}
...
void Sequences_new_scene_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	sequence = rna_Sequences_new_scene(_selfid, _self, CTX_data_main(C), name, scene, channel, frame_start);
	*((struct Sequence **)_retdata) = sequence;
}

struct Sequence *Sequences_new_image_func(struct ID *_selfid, struct Editing *_self, Main *bmain, ReportList *reports, const char * name, const char * filepath, int channel, int frame_start)
{
	return rna_Sequences_new_image(_selfid, _self, bmain, reports, name, filepath, channel, frame_start);
}
...
void Sequences_new_image_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	sequence = rna_Sequences_new_image(_selfid, _self, CTX_data_main(C), reports, name, filepath, channel, frame_start);
	*((struct Sequence **)_retdata) = sequence;
}

struct Sequence *Sequences_new_movie_func(struct ID *_selfid, struct Editing *_self, ReportList *reports, const char * name, const char * filepath, int channel, int frame_start)
{
...
struct Sequence *Sequences_new_sound_func(struct ID *_selfid, struct Editing *_self, Main *bmain, ReportList *reports, const char * name, const char * filepath, int channel, int frame_start)
{
...
struct Sequence *Sequences_new_effect_func(struct ID *_selfid, struct Editing *_self, ReportList *reports, const char * name, int type, int channel, int frame_start, int frame_end, struct Sequence *seq1, struct Sequence *seq2, struct Sequence *seq3)
{
...
void Sequences_remove_func(struct ID *_selfid, struct Editing *_self, Main *bmain, ReportList *reports, struct PointerRNA *sequence)
{
	rna_Sequences_remove(_selfid, _self, bmain, reports, sequence);
}
...
void Sequences_remove_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_Sequences_remove(_selfid, _self, CTX_data_main(C), reports, sequence);
}

/* Repeated prototypes to detect errors */

struct Sequence *rna_Sequences_new_clip(struct ID *_selfid, struct Editing *_self, Main *bmain, const char * name, struct MovieClip *clip, int channel, int frame_start);
struct Sequence *rna_Sequences_new_mask(struct ID *_selfid, struct Editing *_self, Main *bmain, const char * name, struct Mask *mask, int channel, int frame_start);
struct Sequence *rna_Sequences_new_scene(struct ID *_selfid, struct Editing *_self, Main *bmain, const char * name, struct Scene *scene, int channel, int frame_start);
struct Sequence *rna_Sequences_new_image(struct ID *_selfid, struct Editing *_self, Main *bmain, ReportList *reports, const char * name, const char * filepath, int channel, int frame_start);
...
void rna_Sequences_remove(struct ID *_selfid, struct Editing *_self, Main *bmain, ReportList *reports, struct PointerRNA *sequence);
...
StructRNA RNA_SequenceColorBalanceData = {
	{(ContainerRNA *)&RNA_SequenceElement, (ContainerRNA *)&RNA_GPencilSculptSettings,
	NULL,
...
BoolPropertyRNA rna_SequenceProxy_use_proxy_custom_directory = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_invalidate_raw_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
IntPropertyRNA rna_SequenceCrop_max_y = {
	...
	0, 4096, INT_MIN, INT_MAX, 1, 0, NULL
};
...
IntPropertyRNA rna_Sequence_frame_final_duration = {
	...
	rna_Sequence_invalidate_preprocessed_update, 67502080, rna_Sequence_frame_editable, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
IntPropertyRNA rna_Sequence_frame_offset_start = {
	...
	0, -1, NULL},
	Sequence_frame_offset_start_get, Sequence_frame_offset_start_set, NULL, NULL, rna_Sequence_frame_offset_start_range, NULL, NULL, NULL, NULL, NULL,
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};
...
IntPropertyRNA rna_Sequence_frame_offset_end = {
	...
	rna_Sequence_frame_change_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Sequence_frame_offset_end_get, Sequence_frame_offset_end_set, NULL, NULL, rna_Sequence_frame_offset_end_range, NULL, NULL, NULL, NULL, NULL,
	-10000, 10000, INT_MIN, INT_MAX, 1, 0, NULL
};

IntPropertyRNA rna_Sequence_frame_still_start = {
	{(PropertyRNA *)&rna_Sequence_frame_still_end, (PropertyRNA *)&rna_Sequence_frame_offset_end,
	-1, "frame_still_start", 3, 0, 0, 0, 0, "Start Still",
	"",
	0, "*",
	PROP_INT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_frame_change_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
IntPropertyRNA rna_Sequence_frame_still_end = {
	...
	-1, "frame_still_end", 3, 0, 0, 0, 0, "End Still",
	"",
	0, "*",
	PROP_INT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_frame_change_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
IntPropertyRNA rna_Sequence_channel = {
	...
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_invalidate_preprocessed_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
EnumPropertyRNA rna_Sequence_blend_type = {
	...
	-1, "blend_type", 3, 0, 0, 0, 0, "Blending Mode",
...
FloatPropertyRNA rna_Sequence_blend_alpha = {
	...
	rna_Sequence_invalidate_composite_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
CollectionPropertyRNA rna_Sequence_modifiers = {
	{(PropertyRNA *)&rna_Sequence_use_cache_raw, (PropertyRNA *)&rna_Sequence_speed_factor,
...
BoolPropertyRNA rna_SequenceEditor_show_overlay = {
	...
	-1, "show_overlay", 3, 0, 0, 0, 0, "Show Overlay",
...
BoolPropertyRNA rna_SequenceEditor_use_prefetch = {
	{(PropertyRNA *)&rna_SequenceEditor_recycle_max_cost, (PropertyRNA *)&rna_SequenceEditor_use_cache_final,
...
FloatPropertyRNA rna_SequenceEditor_recycle_max_cost = {
	{NULL, (PropertyRNA *)&rna_SequenceEditor_use_prefetch,
	-1, "recycle_max_cost", 3, 0, 0, 4, 0, "Recycle Up To Cost",
	"Only frames with cost lower than this value will be recycled",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Editing, recycle_max_cost), 5, NULL},
	SequenceEditor_recycle_max_cost_get, SequenceEditor_recycle_max_cost_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10.0f, 0.0f, 10.0f, 0.1000000015f, 1, 0.0f, NULL
};

StructRNA RNA_SequenceEditor = {
	{(ContainerRNA *)&RNA_Sequences, (ContainerRNA *)&RNA_SequenceModifiers,
	NULL,
	{(PropertyRNA *)&rna_SequenceEditor_rna_properties, (PropertyRNA *)&rna_SequenceEditor_recycle_max_cost}},
...
BoolPropertyRNA rna_ImageSequence_use_deinterlace = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_reopen_files_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
PointerPropertyRNA rna_SceneSequence_scene = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_scene_switch_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
EnumPropertyRNA rna_SceneSequence_scene_input = {
	...
	-1, "scene_input", 3, 0, 0, 0, 0, "Input",
	"Input type to use for the Scene strip",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_use_sequence, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	SceneSequence_scene_input_get, SceneSequence_scene_input_set, NULL, NULL, NULL, NULL, rna_SceneSequence_scene_input_items, 2, 0
};
...
FloatPropertyRNA rna_SoundSequence_volume = {
	...
	0, "Sound",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_audio_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
FloatPropertyRNA rna_SoundSequence_pitch = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_audio_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Sequence, pitch), 5, NULL},
...
EnumPropertyRNA rna_ColorMixSequence_blend_effect = {
	...
	-1, "blend_effect", 3, 0, 0, 0, 0, "Blending Mode",
	"Method for controlling how the strip combines with other strips",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_invalidate_preprocessed_update, 67502080, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	ColorMixSequence_blend_effect_get, ColorMixSequence_blend_effect_set, NULL, NULL, NULL, NULL, rna_ColorMixSequence_blend_effect_items, 25, 46
};
...
FloatPropertyRNA rna_BrightContrastModifier_contrast = {
	...
	BrightContrastModifier_contrast_get, BrightContrastModifier_contrast_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -100.0f, 100.0f, -100.0f, 100.0f, 10.0f, 3, 0.0f, NULL
};
