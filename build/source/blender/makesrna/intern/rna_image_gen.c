...
int Image_gl_touch_func(struct Image *_self, ReportList *reports, int frame)
{
	return rna_Image_gl_touch(_self, reports, frame);
}
...
void Image_gl_touch_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	error = rna_Image_gl_touch(_self, reports, frame);
	*((int *)_retdata) = error;
}

int Image_gl_load_func(struct Image *_self, ReportList *reports, int frame)
{
	return rna_Image_gl_load(_self, reports, frame);
}
...
void Image_gl_load_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	error = rna_Image_gl_load(_self, reports, frame);
	*((int *)_retdata) = error;
}
...
int rna_Image_gl_touch(struct Image *_self, ReportList *reports, int frame);
int rna_Image_gl_load(struct Image *_self, ReportList *reports, int frame);
...
StructRNA RNA_RenderSlot = {
	{(ContainerRNA *)&RNA_UDIMTile, (ContainerRNA *)&RNA_GpencilVertexGroupElement,
	NULL,
...
StringPropertyRNA rna_UDIMTile_label = {
	...
	NULL, 171114496, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	UDIMTile_label_get, UDIMTile_label_length, UDIMTile_label_set, NULL, NULL, NULL, 64, ""
};

IntPropertyRNA rna_UDIMTile_number = {
	{NULL, (PropertyRNA *)&rna_UDIMTile_label,
...
StructRNA RNA_UDIMTile = {
	...
	NULL,
	{(PropertyRNA *)&rna_UDIMTile_rna_properties, (PropertyRNA *)&rna_UDIMTile_number}},
...
static const EnumPropertyItem rna_Image_file_format_items[19] = {
	{0, "", 0, "Image", NULL},
...
EnumPropertyRNA rna_Image_file_format = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Image_file_format_get, Image_file_format_set, NULL, NULL, NULL, NULL, rna_Image_file_format_items, 18, 0
};
...
EnumPropertyRNA rna_Image_source = {
	...
	NULL, 171114496, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Image_source_get, Image_source_set, rna_Image_source_itemf, NULL, NULL, NULL, rna_Image_source_items, 6, 1
};
...
EnumPropertyRNA rna_Image_generated_type = {
	...
	0, -1, NULL},
	Image_generated_type_get, Image_generated_type_set, NULL, NULL, NULL, NULL, rna_Image_generated_type_items, 3, 1
};
...
FloatPropertyRNA rna_Image_display_aspect = {
	...
	NULL, NULL, Image_display_aspect_get, Image_display_aspect_set, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 5000.0f, 0.1000000015f, FLT_MAX, 1.0f, 2, 1.0f, rna_Image_display_aspect_default
};
...
EnumPropertyRNA rna_Image_alpha_mode = {
	...
	0, -1, NULL},
	Image_alpha_mode_get, Image_alpha_mode_set, NULL, NULL, NULL, NULL, rna_Image_alpha_mode_items, 4, 0
};
...
BoolPropertyRNA rna_Image_use_half_precision = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Image_gpu_texture_update, 171114496, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
static const EnumPropertyItem rna_Image_unpack_method_items[6] = {
	{8, "REMOVE", 0, "Remove Pack", ""},
...
EnumPropertyRNA rna_Image_unpack_method = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_Image_unpack_method_items, 5, 5
};
...
IntPropertyRNA rna_Image_gl_touch_frame = {
	{(PropertyRNA *)&rna_Image_gl_touch_error, NULL,
...
IntPropertyRNA rna_Image_gl_touch_error = {
	{NULL, (PropertyRNA *)&rna_Image_gl_touch_frame,
...
IntPropertyRNA rna_Image_gl_load_frame = {
	{(PropertyRNA *)&rna_Image_gl_load_error, NULL,
	-1, "frame", 3, 0, 0, 0, 0, "Frame",
	"Frame of image sequence or movie",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
IntPropertyRNA rna_Image_gl_load_error = {
	{NULL, (PropertyRNA *)&rna_Image_gl_load_frame,
	-1, "error", 3, 0, 2, 0, 0, "Error",
	"OpenGL error value",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
