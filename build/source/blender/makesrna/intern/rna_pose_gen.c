...
FloatPropertyRNA rna_PoseBone_bbone_scaleinx;
FloatPropertyRNA rna_PoseBone_bbone_scaleiny;
FloatPropertyRNA rna_PoseBone_bbone_scaleoutx;
FloatPropertyRNA rna_PoseBone_bbone_scaleouty;
...
float PoseBone_bbone_scaleinx_get(PointerRNA *ptr)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    return (float)(data->scale_in_x);
}

void PoseBone_bbone_scaleinx_set(PointerRNA *ptr, float value)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    data->scale_in_x = value;
}

float PoseBone_bbone_scaleiny_get(PointerRNA *ptr)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    return (float)(data->scale_in_y);
}

void PoseBone_bbone_scaleiny_set(PointerRNA *ptr, float value)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    data->scale_in_y = value;
}

float PoseBone_bbone_scaleoutx_get(PointerRNA *ptr)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    return (float)(data->scale_out_x);
}

void PoseBone_bbone_scaleoutx_set(PointerRNA *ptr, float value)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    data->scale_out_x = value;
}

float PoseBone_bbone_scaleouty_get(PointerRNA *ptr)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
    return (float)(data->scale_out_y);
}

void PoseBone_bbone_scaleouty_set(PointerRNA *ptr, float value)
{
    bPoseChannel *data = (bPoseChannel *)(ptr->data);
...
{
    rna_PoseChannel_bone_custom_set(ptr, value, reports);
}
...
struct bActionGroup *BoneGroups_new_func(struct ID *_selfid, struct bPose *_self, const char * name)
{
...
BoolPropertyRNA rna_Pose_use_mirror_relative = {
	...
	-1, "use_mirror_relative", 65539, 0, 0, 0, 0, "Relative Mirror",
...
FloatPropertyRNA rna_PoseBone_bbone_rollin = {
	...
	PoseBone_bbone_rollin_get, PoseBone_bbone_rollin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_rollout = {
	...
	PoseBone_bbone_rollout_get, PoseBone_bbone_rollout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveinx = {
	...
	PoseBone_bbone_curveinx_get, PoseBone_bbone_curveinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveiny = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(bPoseChannel, curve_in_y), 5, NULL},
	PoseBone_bbone_curveiny_get, PoseBone_bbone_curveiny_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveoutx = {
	...
	PoseBone_bbone_curveoutx_get, PoseBone_bbone_curveoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_curveouty = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(bPoseChannel, curve_out_y), 5, NULL},
	PoseBone_bbone_curveouty_get, PoseBone_bbone_curveouty_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_PoseBone_bbone_easein = {
	...
	PoseBone_bbone_easein_get, PoseBone_bbone_easein_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_PoseBone_bbone_easeout = {
	{(PropertyRNA *)&rna_PoseBone_bbone_scaleinx, (PropertyRNA *)&rna_PoseBone_bbone_easein,
	...
	PoseBone_bbone_easeout_get, PoseBone_bbone_easeout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_PoseBone_bbone_scaleinx = {
	{(PropertyRNA *)&rna_PoseBone_bbone_scaleiny, (PropertyRNA *)&rna_PoseBone_bbone_easeout,
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(bPoseChannel, scale_in_x), 5, NULL},
	PoseBone_bbone_scaleinx_get, PoseBone_bbone_scaleinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_PoseBone_bbone_scaleiny = {
	{(PropertyRNA *)&rna_PoseBone_bbone_scaleoutx, (PropertyRNA *)&rna_PoseBone_bbone_scaleinx,
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(bPoseChannel, scale_in_y), 5, NULL},
	PoseBone_bbone_scaleiny_get, PoseBone_bbone_scaleiny_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_PoseBone_bbone_scaleoutx = {
	{(PropertyRNA *)&rna_PoseBone_bbone_scaleouty, (PropertyRNA *)&rna_PoseBone_bbone_scaleiny,
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(bPoseChannel, scale_out_x), 5, NULL},
	PoseBone_bbone_scaleoutx_get, PoseBone_bbone_scaleoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_PoseBone_bbone_scaleouty = {
	{(PropertyRNA *)&rna_PoseBone_bbone_custom_handle_start, (PropertyRNA *)&rna_PoseBone_bbone_scaleoutx,
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_update, 85196800, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(bPoseChannel, scale_out_y), 5, NULL},
	PoseBone_bbone_scaleouty_get, PoseBone_bbone_scaleouty_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

PointerPropertyRNA rna_PoseBone_bbone_custom_handle_start = {
	{(PropertyRNA *)&rna_PoseBone_bbone_custom_handle_end, (PropertyRNA *)&rna_PoseBone_bbone_scaleouty,
...
FloatPropertyRNA rna_PoseBone_length = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	PoseBone_length_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
PointerPropertyRNA rna_PoseBone_custom_shape = {
	...
	-1, "custom_shape", 8388737, 2, 0, 0, 0, "Custom Object",
	"Object that defines custom draw type for this bone",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Pose_dependency_update, 85196800, rna_PoseChannel_proxy_editable, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
...
FunctionRNA rna_PoseBoneConstraints_move_func = {
	{NULL, (FunctionRNA *)&rna_PoseBoneConstraints_remove_func,
	NULL,
...
StructRNA RNA_PoseBoneConstraints = {
	...
	NULL,
	NULL,
	{(FunctionRNA *)&rna_PoseBoneConstraints_new_func, (FunctionRNA *)&rna_PoseBoneConstraints_move_func}
};
...
static const EnumPropertyItem rna_BoneGroup_color_set_items[23] = {
	...
	{1, "THEME01", 839, "01 - Theme Color Set", ""},
	{2, "THEME02", 840, "02 - Theme Color Set", ""},
	{3, "THEME03", 841, "03 - Theme Color Set", ""},
	{4, "THEME04", 842, "04 - Theme Color Set", ""},
	{5, "THEME05", 843, "05 - Theme Color Set", ""},
	{6, "THEME06", 844, "06 - Theme Color Set", ""},
	{7, "THEME07", 845, "07 - Theme Color Set", ""},
	{8, "THEME08", 846, "08 - Theme Color Set", ""},
	{9, "THEME09", 847, "09 - Theme Color Set", ""},
	{10, "THEME10", 848, "10 - Theme Color Set", ""},
	{11, "THEME11", 849, "11 - Theme Color Set", ""},
	{12, "THEME12", 850, "12 - Theme Color Set", ""},
	{13, "THEME13", 851, "13 - Theme Color Set", ""},
	{14, "THEME14", 852, "14 - Theme Color Set", ""},
	{15, "THEME15", 853, "15 - Theme Color Set", ""},
	{16, "THEME16", 854, "16 - Theme Color Set", ""},
	{17, "THEME17", 855, "17 - Theme Color Set", ""},
	{18, "THEME18", 856, "18 - Theme Color Set", ""},
	{19, "THEME19", 857, "19 - Theme Color Set", ""},
	{20, "THEME20", 858, "20 - Theme Color Set", ""},
