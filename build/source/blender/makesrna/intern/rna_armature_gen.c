...
FloatPropertyRNA rna_Bone_bbone_scaleinx;
FloatPropertyRNA rna_Bone_bbone_scaleiny;
FloatPropertyRNA rna_Bone_bbone_scaleoutx;
FloatPropertyRNA rna_Bone_bbone_scaleouty;
...
FloatPropertyRNA rna_EditBone_bbone_scaleinx;
FloatPropertyRNA rna_EditBone_bbone_scaleiny;
FloatPropertyRNA rna_EditBone_bbone_scaleoutx;
FloatPropertyRNA rna_EditBone_bbone_scaleouty;
...
float Bone_bbone_scaleinx_get(PointerRNA *ptr)
{
    Bone *data = (Bone *)(ptr->data);
    return (float)(data->scale_in_x);
}

void Bone_bbone_scaleinx_set(PointerRNA *ptr, float value)
{
    Bone *data = (Bone *)(ptr->data);
    data->scale_in_x = value;
}

float Bone_bbone_scaleiny_get(PointerRNA *ptr)
{
    Bone *data = (Bone *)(ptr->data);
    return (float)(data->scale_in_y);
}

void Bone_bbone_scaleiny_set(PointerRNA *ptr, float value)
{
    Bone *data = (Bone *)(ptr->data);
    data->scale_in_y = value;
}

float Bone_bbone_scaleoutx_get(PointerRNA *ptr)
{
    Bone *data = (Bone *)(ptr->data);
    return (float)(data->scale_out_x);
}

void Bone_bbone_scaleoutx_set(PointerRNA *ptr, float value)
{
    Bone *data = (Bone *)(ptr->data);
    data->scale_out_x = value;
}

float Bone_bbone_scaleouty_get(PointerRNA *ptr)
{
    Bone *data = (Bone *)(ptr->data);
    return (float)(data->scale_out_y);
}

void Bone_bbone_scaleouty_set(PointerRNA *ptr, float value)
{
    Bone *data = (Bone *)(ptr->data);
    data->scale_out_y = value;
}
...
float EditBone_bbone_scaleinx_get(PointerRNA *ptr)
{
    EditBone *data = (EditBone *)(ptr->data);
    return (float)(data->scale_in_x);
}

void EditBone_bbone_scaleinx_set(PointerRNA *ptr, float value)
{
    EditBone *data = (EditBone *)(ptr->data);
    data->scale_in_x = value;
}

float EditBone_bbone_scaleiny_get(PointerRNA *ptr)
{
    EditBone *data = (EditBone *)(ptr->data);
    return (float)(data->scale_in_y);
}

void EditBone_bbone_scaleiny_set(PointerRNA *ptr, float value)
{
    EditBone *data = (EditBone *)(ptr->data);
    data->scale_in_y = value;
}

float EditBone_bbone_scaleoutx_get(PointerRNA *ptr)
{
    EditBone *data = (EditBone *)(ptr->data);
    return (float)(data->scale_out_x);
}

void EditBone_bbone_scaleoutx_set(PointerRNA *ptr, float value)
{
    EditBone *data = (EditBone *)(ptr->data);
    data->scale_out_x = value;
}

float EditBone_bbone_scaleouty_get(PointerRNA *ptr)
{
    EditBone *data = (EditBone *)(ptr->data);
    return (float)(data->scale_out_y);
}

void EditBone_bbone_scaleouty_set(PointerRNA *ptr, float value)
{
    EditBone *data = (EditBone *)(ptr->data);
    data->scale_out_y = value;
}
...
EnumPropertyRNA rna_Armature_display_type = {
	...
	-1, "display_type", 65539, 0, 0, 0, 0, "Display Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_Armature_show_names = {
	{(PropertyRNA *)&rna_Armature_use_mirror_x, (PropertyRNA *)&rna_Armature_show_axes,
...
EnumPropertyRNA rna_Bone_inherit_scale = {
	...
	-1, "inherit_scale", 3, 0, 0, 0, 0, "Inherit Scale",
	"Specifies how the bone inherits scaling from the parent bone",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Bone_inherit_scale_get, Bone_inherit_scale_set, NULL, NULL, NULL, NULL, rna_Bone_inherit_scale_items, 6, 0
};
...
FloatPropertyRNA rna_Bone_bbone_x = {
	...
	Bone_bbone_x_get, Bone_bbone_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_z = {
	...
	Bone_bbone_z_get, Bone_bbone_z_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_rollin = {
	...
	Bone_bbone_rollin_get, Bone_bbone_rollin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_rollout = {
	...
	Bone_bbone_rollout_get, Bone_bbone_rollout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_curveinx = {
	...
	Bone_bbone_curveinx_get, Bone_bbone_curveinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_curveiny = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, curve_in_y), 5, NULL},
	Bone_bbone_curveiny_get, Bone_bbone_curveiny_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_curveoutx = {
	...
	Bone_bbone_curveoutx_get, Bone_bbone_curveoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_curveouty = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, curve_out_y), 5, NULL},
	Bone_bbone_curveouty_get, Bone_bbone_curveouty_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_Bone_bbone_easein = {
	...
	Bone_bbone_easein_get, Bone_bbone_easein_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_Bone_bbone_easeout = {
	{(PropertyRNA *)&rna_Bone_bbone_scaleinx, (PropertyRNA *)&rna_Bone_bbone_easein,
	...
	Bone_bbone_easeout_get, Bone_bbone_easeout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_Bone_bbone_scaleinx = {
	{(PropertyRNA *)&rna_Bone_bbone_scaleiny, (PropertyRNA *)&rna_Bone_bbone_easeout,
	-1, "bbone_scaleinx", 67108867, 0, 0, 4, 0, "Scale In X",
	"X-axis scale factor for start of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, scale_in_x), 5, NULL},
	Bone_bbone_scaleinx_get, Bone_bbone_scaleinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_Bone_bbone_scaleiny = {
	{(PropertyRNA *)&rna_Bone_bbone_scaleoutx, (PropertyRNA *)&rna_Bone_bbone_scaleinx,
	-1, "bbone_scaleiny", 67108867, 0, 0, 4, 0, "Scale In Y",
	"Y-axis scale factor for start of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, scale_in_y), 5, NULL},
	Bone_bbone_scaleiny_get, Bone_bbone_scaleiny_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_Bone_bbone_scaleoutx = {
	{(PropertyRNA *)&rna_Bone_bbone_scaleouty, (PropertyRNA *)&rna_Bone_bbone_scaleiny,
	-1, "bbone_scaleoutx", 67108867, 0, 0, 4, 0, "Scale Out X",
	"X-axis scale factor for end of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, scale_out_x), 5, NULL},
	Bone_bbone_scaleoutx_get, Bone_bbone_scaleoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_Bone_bbone_scaleouty = {
	{(PropertyRNA *)&rna_Bone_hide, (PropertyRNA *)&rna_Bone_bbone_scaleoutx,
	-1, "bbone_scaleouty", 67108867, 0, 0, 4, 0, "Scale Out Y",
	"Y-axis scale factor for end of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, scale_out_y), 5, NULL},
	Bone_bbone_scaleouty_get, Bone_bbone_scaleouty_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

BoolPropertyRNA rna_Bone_hide = {
	{(PropertyRNA *)&rna_Bone_select, (PropertyRNA *)&rna_Bone_bbone_scaleouty,
...
FloatPropertyRNA rna_Bone_matrix = {
	...
	-1, "matrix", 2, 0, 0, 4, 0, "Bone Matrix",
	"3x3 bone matrix",
	0, "*",
	PROP_FLOAT, PROP_MATRIX | PROP_UNIT_NONE, NULL, 2, {3, 3, 0}, 9,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, bone_mat), 5, NULL},
	NULL, NULL, Bone_matrix_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Bone_matrix_default
};
...
FloatPropertyRNA rna_Bone_matrix_local = {
	...
	-1, "matrix_local", 2, 0, 0, 4, 0, "Bone Armature-Relative Matrix",
	"4x4 bone matrix relative to armature",
	0, "*",
	PROP_FLOAT, PROP_MATRIX | PROP_UNIT_NONE, NULL, 2, {4, 4, 0}, 16,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, arm_mat), 5, NULL},
	NULL, NULL, Bone_matrix_local_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, rna_Bone_matrix_local_default
};
...
FloatPropertyRNA rna_Bone_tail = {
	...
	NULL, NULL, Bone_tail_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_Bone_tail_default
};
...
FloatPropertyRNA rna_Bone_tail_local = {
	...
	-1, "tail_local", 2, 0, 0, 4, 0, "Armature-Relative Tail",
	"Location of tail end of the bone relative to armature",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, arm_tail), 5, NULL},
	NULL, NULL, Bone_tail_local_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_Bone_tail_local_default
};
...
FloatPropertyRNA rna_Bone_head = {
	...
	-1, "head", 2, 0, 0, 4, 0, "Head",
	"Location of head end of the bone relative to its parent",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, head), 5, NULL},
	NULL, NULL, Bone_head_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_Bone_head_default
};
...
FloatPropertyRNA rna_Bone_head_local = {
	...
	-1, "head_local", 2, 0, 0, 4, 0, "Armature-Relative Head",
	"Location of head end of the bone relative to armature",
	0, "*",
	PROP_FLOAT, PROP_TRANSLATION | PROP_UNIT_LENGTH, NULL, 1, {3, 0, 0}, 3,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(Bone, arm_head), 5, NULL},
	NULL, NULL, Bone_head_local_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, rna_Bone_head_local_default
};
...
FloatPropertyRNA rna_Bone_length = {
	...
	Bone_length_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_length = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_length_get, EditBone_length_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
EnumPropertyRNA rna_EditBone_inherit_scale = {
	...
	rna_Armature_update_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_inherit_scale_get, EditBone_inherit_scale_set, NULL, NULL, NULL, NULL, rna_EditBone_inherit_scale_items, 6, 0
};
...
FloatPropertyRNA rna_EditBone_bbone_x = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_x_get, EditBone_bbone_x_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_z = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_z_get, EditBone_bbone_z_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_rollin = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_rollin_get, EditBone_bbone_rollin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_rollout = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_rollout_get, EditBone_bbone_rollout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -6.2831854820f, 6.2831854820f, -FLT_MAX, FLT_MAX, 10.0f, 2, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_curveinx = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_curveinx_get, EditBone_bbone_curveinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_curveiny = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_curveiny_get, EditBone_bbone_curveiny_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_curveoutx = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_curveoutx_get, EditBone_bbone_curveoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_curveouty = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_curveouty_get, EditBone_bbone_curveouty_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 5, 0.0f, NULL
};
...
FloatPropertyRNA rna_EditBone_bbone_easein = {
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_easein_get, EditBone_bbone_easein_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_EditBone_bbone_easeout = {
	{(PropertyRNA *)&rna_EditBone_bbone_scaleinx, (PropertyRNA *)&rna_EditBone_bbone_easein,
	...
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_easeout_get, EditBone_bbone_easeout_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -5.0f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_EditBone_bbone_scaleinx = {
	{(PropertyRNA *)&rna_EditBone_bbone_scaleiny, (PropertyRNA *)&rna_EditBone_bbone_easeout,
	-1, "bbone_scaleinx", 67108867, 0, 0, 0, 0, "Scale In X",
	"X-axis scale factor for start of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_scaleinx_get, EditBone_bbone_scaleinx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_EditBone_bbone_scaleiny = {
	{(PropertyRNA *)&rna_EditBone_bbone_scaleoutx, (PropertyRNA *)&rna_EditBone_bbone_scaleinx,
	-1, "bbone_scaleiny", 67108867, 0, 0, 0, 0, "Scale In Y",
	"Y-axis scale factor for start of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_scaleiny_get, EditBone_bbone_scaleiny_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_EditBone_bbone_scaleoutx = {
	{(PropertyRNA *)&rna_EditBone_bbone_scaleouty, (PropertyRNA *)&rna_EditBone_bbone_scaleiny,
	-1, "bbone_scaleoutx", 67108867, 0, 0, 0, 0, "Scale Out X",
	"X-axis scale factor for end of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_scaleoutx_get, EditBone_bbone_scaleoutx_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_EditBone_bbone_scaleouty = {
	{(PropertyRNA *)&rna_EditBone_hide, (PropertyRNA *)&rna_EditBone_bbone_scaleoutx,
	-1, "bbone_scaleouty", 67108867, 0, 0, 0, 0, "Scale Out Y",
	"Y-axis scale factor for end of the B-Bone, adjusts thickness (for tapering effects)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_editbone_transform_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	EditBone_bbone_scaleouty_get, EditBone_bbone_scaleouty_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, -FLT_MAX, FLT_MAX, 1.0f, 3, 1.0f, NULL
};

BoolPropertyRNA rna_EditBone_hide = {
	{(PropertyRNA *)&rna_EditBone_lock, (PropertyRNA *)&rna_EditBone_bbone_scaleouty,
